<div class="offcanvas offcanvas-end" tabindex="-1" id="switcher-canvas" aria-labelledby="offcanvasRightLabel">
            ...
            <div class="tab-pane fade border-0" id="switcher-profile" role="tabpanel" aria-labelledby="switcher-profile-tab" tabindex="0">
                ...
                <div class="theme-colors">
                    ...
                    <div class="d-flex flex-wrap align-items-center switcher-style">
                        ...
                        <div class="form-check switch-select ps-0 mt-1 color-bg-light">
                ...
                <div class="theme-colors">
                    <p class="switcher-style-head">Menu Background Image:</p>
                    <div class="d-flex flex-wrap align-items-center switcher-style">
                        <div class="form-check switch-select m-2">
                            <input class="form-check-input bgimage-input bg-img1" type="radio" name="theme-background-image" id="switcher-bg-img">
                        </div>
                        <div class="form-check switch-select m-2">
                            <input class="form-check-input bgimage-input bg-img2" type="radio" name="theme-background-image" id="switcher-bg-img1">
                        </div>
                        <div class="form-check switch-select m-2">
                            <input class="form-check-input bgimage-input bg-img3" type="radio" name="theme-background-image" id="switcher-bg-img2">
                        </div>
                        <div class="form-check switch-select m-2">
                            <input class="form-check-input bgimage-input bg-img4" type="radio" name="theme-background-image" id="switcher-bg-img3">
                        </div>
                        <div class="form-check switch-select m-2">
                            <input class="form-check-input bgimage-input bg-img5" type="radio" name="theme-background-image" id="switcher-bg-img4">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="offcanvas-footer p-3 border-top">
        <div class="d-grid">
            <button class="btn btn-danger" id="reset-all">Reset</button>
        </div>
    </div>
</div>

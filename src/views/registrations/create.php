            ...
            <form id="patientForm" class="needs-validation" novalidate>
                                ...
                                <div class="col-5">
                                    ...
                                    <div class="input-group">
                                        <input type="tel" class="form-control" name="emergency_contact_mobile"
                                            id="emergency_contact_mobile" maxlength="10" placeholder="10 digits">
                ...
                <div class="d-flex justify-content-between align-items-center mt-3 flex-wrap gap-2">
                    ...
                    <button type="button" class="btn btn-primary" onclick="goToStep(4)">
                        Next: Service Selection <i class="ri-arrow-right-line ms-1"></i>
                    </button>
                </div>
            </form>
        </div>

        <!-- Step 4: Visit Selection -->
        <div id="step4" class="d-none step-content">
            <div class="card custom-card border-0 shadow-sm">
                <div class="card-body p-4">
                    <div class="mb-4">
                        <h5 class="fw-bold text-dark mb-1">Step 4: Visit Registration</h5>
                        <p class="text-muted fs-13">Choose the type of service for this registration</p>
                    </div>
                    ...
                    <div class="row g-4 mb-4">
                        ...
                        <div class="col-md-12">
                            <div class="row g-3">
                                <div class="col-md-3">
                                    <div class="visit-type-card active" onclick="selectVisitType('REG', this)">
                                        <div class="visit-icon bg-secondary-transparent text-secondary"><i
                                                class="ri-user-add-line"></i></div>
                                        <div class="visit-title">Registration Only</div>
                                        <div class="visit-desc">Create patient record only</div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="visit-type-card" onclick="selectVisitType('OPD', this)">
                                        <div class="visit-icon bg-primary-transparent text-primary"><i
                                                class="ri-stethoscope-line"></i></div>
                                        <div class="visit-title">OPD Visit</div>
                                        <div class="visit-desc">Consultation & Token</div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="visit-type-card" onclick="selectVisitType('IPD', this)">
                                        <div class="visit-icon bg-info-transparent text-info"><i
                                                class="ri-hotel-bed-line"></i></div>
                                        <div class="visit-title">IPD Admission</div>
                                        <div class="visit-desc">In-patient admission</div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="visit-type-card" onclick="selectVisitType('ER', this)">
                                        <div class="visit-icon bg-danger-transparent text-danger"><i
                                                class="ri-pulse-line"></i></div>
                                        <div class="visit-title">Emergency (ER)</div>
                                        <div class="visit-desc">Urgent trauma/ER care</div>
                                    </div>
                                </div>
                            </div>
                            <input type="hidden" id="selected_visit_type" value="REG">
                        </div>

                        <!-- OPD Specific Fields -->
                        <div id="opdFields" class="col-12 d-none">
                            <div class="form-section">
                                <div class="form-section-title"><i class="ri-stethoscope-line"></i> OPD Consultation
                                    Details</div>
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <label class="form-label">Consulting Doctor <span
                                                class="text-danger">*</span></label>
                                        <select class="form-select" id="opd_doctor_id">
                                            <option value="">Select Doctor</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Consultation Type</label>
                                        <select class="form-select" id="opd_type">
                        ...
                        <!-- IPD Specific Fields -->
                        <div id="ipdFields" class="col-12 d-none">
                            <div class="form-section">
                                <div class="form-section-title"><i class="ri-hotel-bed-line"></i> IP Admission Details
                                </div>
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <label class="form-label">Primary Doctor <span
                                                class="text-danger">*</span></label>
                                        <select class="form-select" id="ipd_doctor_id">
                                            <option value="">Select Doctor</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label">Ward <span class="text-danger">*</span></label>
                                        <select class="form-select" id="ipd_ward_id" onchange="loadBeds(this.value)">
                                            <option value="">Select Ward</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label">Bed No <span class="text-danger">*</span></label>
                                        <select class="form-select" id="ipd_bed_id">
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-4">
                        ...
                        <button type="button" class="btn btn-success btn-lg px-5 fw-bold" id="submitBtn"
                            onclick="submitPatient()">
                            <span class="spinner-border spinner-border-sm d-none me-2" id="submitSpinner"></span>
                            <i class="ri-check-double-line me-1" id="submitIcon"></i>Complete Registration
                        </button>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
            <div class="modal-body text-center p-5">
                ...
                <h4 class="fw-bold text-success mb-2">Registration Complete!</h4>
                <p class="text-muted mb-4" id="successMsg">Patient has been successfully registered.</p>

                <div class="row g-2 mb-4">
                    <div class="col-6">
                        <div class="bg-light rounded p-3 h-100">
                            <span class="text-muted fs-11 d-block text-uppercase fw-bold mb-1">Medical Record No</span>
                            <h5 class="mb-0 text-primary fw-bold" id="successMRN"></h5>
                        </div>
                    </div>
                    <div class="col-6 d-none" id="visitSuccessBox">
                        <div class="bg-primary-transparent rounded p-3 h-100">
                            <span class="text-primary fs-11 d-block text-uppercase fw-bold mb-1" id="visitLabel">Visit
                                ID</span>
                            <h5 class="mb-0 text-primary fw-bold" id="successVisitID"></h5>
                        </div>
                    </div>
                </div>

                <div class="d-grid gap-2">
                    <button type="button" class="btn btn-success py-2 d-flex align-items-center justify-content-center"
                        onclick="printRegistrationSlip()">
                        <i class="ri-printer-line me-2"></i>Print Registration Slip
                    </button>
                    <div class="d-flex gap-2 mt-2">
                        <button type="button" class="btn btn-outline-primary flex-fill" onclick="registerAnother()">
                            <i class="ri-add-line me-1"></i>New Patient
                        </button>
                        <a href="<?= baseUrl('/patients') ?>" id="successActionBtn" class="btn btn-primary flex-fill">
                            <i class="ri-eye-line me-1"></i>View Record
                        </a>
                    </div>
                </div>
            </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (mobileInput) {
            ...
            // Handle Enter key for mobile lookup
    ...
    function goToStep(step) {
        ...
        if (step === 3) {
            ...
            // Pre-load necessary data for Step 4
            loadStep4Data();
        } else {
            container.classList.remove('wide-form');
        }
        ...
        // Update step lines
        if (document.getElementById('stepLine1')) document.getElementById('stepLine1').classList.toggle('completed', step > 1);
        if (document.getElementById('stepLine2')) document.getElementById('stepLine2').classList.toggle('completed', step > 2);
        if (document.getElementById('stepLine3')) document.getElementById('stepLine3').classList.toggle('completed', step > 3);

        currentStep = step;
        window.scrollTo(0, 0);
    }

    function selectVisitType(type, element) {
        document.getElementById('selected_visit_type').value = type;

        // UI updates
        document.querySelectorAll('.visit-type-card').forEach(c => c.classList.remove('active'));
        element.classList.add('active');

        // Show/hide fields
        document.getElementById('opdFields').classList.add('d-none');
        document.getElementById('ipdFields').classList.add('d-none');

        if (type === 'OPD' || type === 'ER') {
            document.getElementById('opdFields').classList.remove('d-none');
        } else if (type === 'IPD') {
            document.getElementById('ipdFields').classList.remove('d-none');
        }
    }

    async function loadStep4Data() {
        // Load Doctors if not already loaded
        const opdDocSelect = document.getElementById('opd_doctor_id');
        const ipdDocSelect = document.getElementById('ipd_doctor_id');

        if (opdDocSelect.options.length <= 1) {
            try {
                const res = await fetch('/api/v1/appointments/providers');
                const data = await res.json();
                if (data.success) {
                    data.data.providers.forEach(p => {
                        const opt = new Option(`${p.full_name} (${p.specialization || 'General'})`, p.provider_id);
                        opdDocSelect.add(opt.cloneNode(true));
                        ipdDocSelect.add(opt);
                    });
                }
            } catch (e) { }
        }
        ...
        // Load Wards
        const wardSelect = document.getElementById('ipd_ward_id');
            ...
            try {
                ...
                if (data.success) {
                    data.data.wards.forEach(w => {
                        const opt = new Option(`${w.ward_name} (${w.available_beds}/${w.total_beds})`, w.ward_id);
                        wardSelect.add(opt);
                    });
                }
            } catch (e) { }
    ...
    async function loadBeds(wardId) {
        if (!wardId) return;
        const bedSelect = document.getElementById('ipd_bed_id');
    ...
    async function submitPatient() {
        ...
        const visitType = document.getElementById('selected_visit_type').value;
        ...
        if (!isNewFamily) {
            ...
            if (!relatedTo || !relationship) {
                showWarning('Family relation is required');
                hasError = true;
            }
        ...
        if (hasError) {
            goToStep(3); // Go back to details if error
            return;
        }

        // Show loading
        const sBtn = document.getElementById('submitBtn');
        const sSpinner = document.getElementById('submitSpinner');
        const sIcon = document.getElementById('submitIcon');

        sSpinner.classList.remove('d-none');
        sIcon.classList.add('d-none');
        sBtn.disabled = true;

        try {
            // Stage 1: Register Patient
            ...
            // Stage 2: Register Visit/Admission if selected
            if (visitType === 'OPD' || visitType === 'ER') {
                const docId = document.getElementById('opd_doctor_id').value;
                if (!docId) {
                    showSuccess(mrn);
                    showWarning('Patient registered, but could not create OPD visit (No doctor selected)');
                } else {
                    const vRes = await fetch('/api/v1/registrations', {
                        method: 'POST',
                        headers: { 'Content-Type': 'application/json' },
                        body: JSON.stringify({
                            patient_id: patientId,
                            visit_type: 'OP', // Using 'OP' for OPD
                            provider_id: docId
                        })
                    });
                    const vResult = await vRes.json();
                    if (vResult.success) {
                        visitInfo = { label: 'Visit ID', id: 'RE-' + String(vResult.data.visit_id).padStart(5, '0'), next: '/visits' };
                    }
                }
            } else if (visitType === 'IPD') {
                const docId = document.getElementById('ipd_doctor_id').value;
                const wardId = document.getElementById('ipd_ward_id').value;
                const bedId = document.getElementById('ipd_bed_id').value;

                if (!docId || !wardId || !bedId) {
                    showSuccess(mrn);
                    showWarning('Patient registered, but could not admit (Details missing)');
                } else {
                    const admRes = await fetch('/api/v1/registrations', {
                        method: 'POST',
                        headers: { 'Content-Type': 'application/json' },
                        body: JSON.stringify({
                            patient_id: patientId,
                            visit_type: 'IP', // Using 'IP' for IPD
                            provider_id: docId,
                            ward_id: wardId,
                            bed_id: bedId
                        })
                    });
                    const admResult = await admRes.json();
                    if (admResult.success) {
                        visitInfo = { label: 'Visit ID', id: 'RE-' + String(admResult.data.visit_id).padStart(5, '0'), next: '/visits' };
                    }
                }
            }
            ...
            document.getElementById('successMRN').textContent = mrn;
            if (visitInfo) {
                document.getElementById('visitSuccessBox').classList.remove('d-none');
                document.getElementById('visitLabel').textContent = visitInfo.label;
                document.getElementById('successVisitID').textContent = visitInfo.id;
                document.getElementById('successActionBtn').href = visitInfo.next;
                document.getElementById('successMsg').innerHTML = `Patient <b>${mrn}</b> registered and ${visitType === 'IPD' ? 'admitted' : 'visit started'}.`;
            } else {
                document.getElementById('visitSuccessBox').classList.add('d-none');
                document.getElementById('successActionBtn').href = `/patients/${patientId}`;
                document.getElementById('successMsg').textContent = 'Patient successfully registered with MRN ' + mrn;
            }
            ...
            showError('Network error during registration. Please check logs.');
            console.error(e);
        } finally {
            sSpinner.classList.add('d-none');
            sIcon.classList.remove('d-none');
    ...
    const districtData = {
        ...
        "Kerala": ["Thiruvananthapuram", "Kochi", "Kozhikode", "Thrissur", "Kollam", "Alappuzha", "Palakad", "Malappuram", "Kannur", "Idukki", "Kottayam", "Kasaragod", "Pathanamthitta", "Wayanad"],
    ...
    function printRegistrationSlip() {
        if (lastRegisteredPatientId) {
            const slipUrl = `<?= baseUrl('/registrations/slip') ?>?patient_id=${lastRegisteredPatientId}`;
            window.open(slipUrl, '_blank');
        } else {
            showWarning('No registered patient found to print slip.');
        }
    }
</script>

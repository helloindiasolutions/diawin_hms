                        ...
                        <div class="col-xl-12">
                            <div class="card custom-card">
                                <div class="card-header justify-content-between">
                                    ...
                                    <div class="d-flex">
                                        <a href="invoice-create.php" class="btn btn-sm btn-primary btn-wave waves-light"><i class="ri-add-line fw-medium align-middle me-1"></i> Create Invoice</a>
...
<?php ob_start(); ?>
        ...
        <script src="<?php echo $baseUrl; ?>/assets/js/invoice-list.js"></script>

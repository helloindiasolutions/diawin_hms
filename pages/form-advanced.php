...
<?php ob_start(); ?>
        ...
        <!-- Auto Complete CSS -->
        <link rel="stylesheet" href="<?php echo $baseUrl; ?>/assets/libs/@tarekraafat/autocomplete.js/css/autoComplete.css">

        <!-- intl-tel-input css -->
        <link rel="stylesheet" href="<?php echo $baseUrl; ?>/assets/libs/intl-tel-input/build/css/intlTelInput.min.css">

        <!-- Tagify CSS -->
        <link rel="stylesheet" href="<?php echo $baseUrl; ?>/assets/libs/@yaireo/tagify/tagify.css">

        <!-- Dragsort CSS -->
        <link rel="stylesheet" href="<?php echo $baseUrl; ?>/assets/libs/@yaireo/dragsort/dragsort.css">

        <!-- Dual ListBox CSS -->
        <link rel="stylesheet" href="<?php echo $baseUrl; ?>/assets/libs/dual-listbox/dual-listbox.css">
...
<?php ob_start(); ?>
        ...
        <!-- Auto Complete JS -->
        <script src="<?php echo $baseUrl; ?>/assets/libs/@tarekraafat/autocomplete.js/autoComplete.min.js"></script>

        <!-- intl-tel-input JS -->
        <script src="<?php echo $baseUrl; ?>/assets/libs/intl-tel-input/build/js/intlTelInput.min.js"></script>

        <!-- Tagify JS -->
        <script src="<?php echo $baseUrl; ?>/assets/libs/@yaireo/tagify/tagify.js"></script>

        <!-- Dragsort JS -->
        <script src="<?php echo $baseUrl; ?>/assets/libs/@yaireo/dragsort/dragsort.js"></script>

        <!-- Dual ListBox JS -->
        <script src="<?php echo $baseUrl; ?>/assets/libs/dual-listbox/dual-listbox.js"></script>

        <!-- Internal Advanced Forms JS -->
        <script src="<?php echo $baseUrl; ?>/assets/js/form-advanced.js"></script>

        <!-- Internal Tagify JS -->
        <script src="<?php echo $baseUrl; ?>/assets/js/tagify.js"></script>

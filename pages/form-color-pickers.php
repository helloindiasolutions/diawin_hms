...
<?php ob_start(); ?>
        ...
        <link rel="stylesheet" href="<?php echo $baseUrl; ?>/assets/libs/@simonwep/pickr/themes/classic.min.css">
        <link rel="stylesheet" href="<?php echo $baseUrl; ?>/assets/libs/@simonwep/pickr/themes/monolith.min.css">
...
<?php ob_start(); ?>
        ...
        <!-- Color Picker JS -->
        <script src="<?php echo $baseUrl; ?>/assets/js/color-picker.js"></script>

                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                            <div class="card custom-card">
                                                ...
                                                <div class="card-body p-2">
                                                    <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/44.png" class="card-img mb-3" alt="...">
                                                    <div class="p-2">
                                                        <div class="mb-3">
                                                            <a href="nft-details.php"><h6 class="fw-semibold mb-1 text-truncate">Neon Assassin</h6></a>
                                        ...
                                        <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                            <div class="card custom-card">
                                                ...
                                                <div class="card-body p-2">
                                                    <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/45.png" class="card-img mb-3" alt="...">
                                                    <div class="p-2">
                                                        <div class="mb-3">
                                                            <a href="nft-details.php"><h6 class="fw-semibold mb-1 text-truncate">Cyber Samurai</h6></a>
                                        ...
                                        <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                            <div class="card custom-card">
                                                ...
                                                <div class="card-body p-2">
                                                    <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/18.png" class="card-img mb-3" alt="...">
                                                    <div class="p-2">
                                                        <div class="mb-3">
                                                            <a href="nft-details.php"><h6 class="fw-semibold mb-1 text-truncate">Robo-Revolution</h6></a>
                                        ...
                                        <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                            <div class="card custom-card">
                                                ...
                                                <div class="card-body p-2">
                                                    <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/14.png" class="card-img mb-3" alt="...">
                                                    <div class="p-2">
                                                        <div class="mb-3">
                                                            <a href="nft-details.php"><h6 class="fw-semibold mb-1 text-truncate">Neon District</h6></a>
                                        ...
                                        <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                            <div class="card custom-card">
                                                ...
                                                <div class="card-body p-2">
                                                    <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/13.png" class="card-img mb-3" alt="...">
                                                    <div class="p-2">
                                                        <div class="mb-3">
                                                            <a href="nft-details.php"><h6 class="fw-semibold mb-1 text-truncate">Synthwave Dream</h6></a>
                                    ...
                                    <div class="row">
                                        <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
                                            <div class="card custom-card">
                                                ...
                                                <div class="card-body p-2">
                                                    <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/12.png" class="card-img mb-3" alt="...">
                                                    <div class="p-2">
                                                        <div class="mb-3">
                                                            <a href="nft-details.php"><h6 class="fw-semibold mb-1 text-truncate">Chrome Guardian</h6></a>
                                        ...
                                        <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
                                            <div class="card custom-card">
                                                ...
                                                <div class="card-body p-2">
                                                    <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/10.png" class="card-img mb-3" alt="...">
                                                    <div class="p-2">
                                                        <div class="mb-3">
                                                            <a href="nft-details.php"><h6 class="fw-semibold mb-1 text-truncate">Electric Reaper</h6></a>
                                        ...
                                        <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
                                            <div class="card custom-card">
                                                ...
                                                <div class="card-body p-2">
                                                    <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/7.png" class="card-img mb-3" alt="...">
                                                    <div class="p-2">
                                                        <div class="mb-3">
                                                            <a href="nft-details.php"><h6 class="fw-semibold mb-1 text-truncate">Robo-Punk Revolution</h6></a>
                                    ...
                                    <div class="row">
                                        <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
                                            <div class="card custom-card">
                                                ...
                                                <div class="card-body p-2">
                                                    <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/5.png" class="card-img mb-3" alt="...">
                                                    <div class="p-2">
                                                        <div class="mb-3">
                                                            <a href="nft-details.php"><h6 class="fw-semibold mb-1 text-truncate">Virtual Dreams</h6></a>
                                        ...
                                        <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
                                            <div class="card custom-card">
                                                ...
                                                <div class="card-body p-2">
                                                    ...
                                                    <div class="p-2">
                                                        <div class="mb-3">
                                                            <a href="nft-details.php"><h6 class="fw-semibold mb-1 text-truncate">CyberTech Warlord</h6></a>

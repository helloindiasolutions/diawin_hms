                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-12">
                            <div class="card custom-card overflow-hidden">
                                <div class="card-body">
                                    <span class="nft-details-auction-time">48hrs : 16mins : 21sec</span>
                                    <div class="row gx-5">
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="swiper swiper-preview-details bg-light product-details-page">
                                                        <div class="swiper-wrapper">
                                                            <div class="swiper-slide" id="img-container">
                                                                <img class="img-fluid" src="<?php echo $baseUrl; ?>/assets/images/nft-images/14.png" alt="img">
                                                            </div>
                                                            <div class="swiper-slide image-container">
                                                                <img class="img-fluid" src="<?php echo $baseUrl; ?>/assets/images/nft-images/13.png" alt="img">
                                                            </div>
                                                            <div class="swiper-slide image-container">
                                                                <img class="img-fluid" src="<?php echo $baseUrl; ?>/assets/images/nft-images/12.png" alt="img">
                                                            </div>
                                                            <div class="swiper-slide image-container">
                                                                <img class="img-fluid" src="<?php echo $baseUrl; ?>/assets/images/nft-images/10.png" alt="img">
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-xxl-12 col-sm-12 d-md-block d-none">
                                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                                        ...
                                                        <a href="javascript:void(0);" class="d-block text-muted fs-13">View All<i class="ti ti-arrow-narrow-right ms-1"></i></a>
                                                    </div>
                                                    <ul class="list-group">
                                                        <li class="list-group-item">
                                                            <div class="d-flex align-items-center gap-2">
                                                                ...
                                                                <div class="flex-fill">
                                                                    ...
                                                                    <span class="d-block text-muted fs-13">0xC4F25B8A...5623</span>
                                                                </div>
                                                                <div class="text-end">
                                                                    <span class="d-block fw-semibold">1.7 ETH</span>
                                                                    <span class="text-muted fs-13">March 25, 2025, 02:30 PM</span>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        <li class="list-group-item">
                                                            <div class="d-flex align-items-center gap-2">
                                                                ...
                                                                <div class="flex-fill">
                                                                    ...
                                                                    <span class="d-block text-muted fs-13">0xA1B2C3D4...8901</span>
                                                                </div>
                                                                <div class="text-end">
                                                                    <span class="d-block fw-semibold">1.6 ETH</span>
                                                                    <span class="text-muted fs-13">March 25, 2025, 02:00 PM</span>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        <li class="list-group-item">
                                                            <div class="d-flex align-items-center gap-2">
                                                                ...
                                                                <div class="flex-fill">
                                                                    ...
                                                                    <span class="d-block text-muted fs-13">0xE6A7C8D9...2341</span>
                                                                </div>
                                                                <div class="text-end">
                                                                    <span class="d-block fw-semibold">1.5 ETH</span>
                                                                    <span class="text-muted fs-13">March 25, 2025, 01:45 PM</span>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        <li class="list-group-item">
                                                            <div class="d-flex align-items-center gap-2">
                                                                ...
                                                                <div class="flex-fill">
                                                                    ...
                                                                    <span class="d-block text-muted fs-13">0xD3F5A1E6...9872</span>
                                                                </div>
                                                                <div class="text-end">
                                                                    <span class="d-block fw-semibold">1.4 ETH</span>
                                                                    <span class="text-muted fs-13">March 25, 2025, 01:30 PM</span>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        <li class="list-group-item">
                                                            <div class="d-flex align-items-center gap-2">
                                                                <div class="lh-1">
                                                                    <span class="avatar avatar-lg">
                                                                        <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/13.png" alt="">
                                                                    </span>
                                                                </div>
                                                                <div class="flex-fill">
                                                                    <span class="d-block fw-semibold">
                                                                    ...
                                                                    <span class="d-block text-muted fs-13">0xA9D0B7C1...3410</span>
                                                                </div>
                                                                <div class="text-end">
                                                                    <span class="d-block fw-semibold">1.3 ETH</span>
                                                                    <span class="text-muted fs-13">March 25, 2025, 01:00 PM</span>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        <li class="list-group-item">
                                                            <div class="d-flex align-items-center gap-2">
                                                                <div class="lh-1">
                                                                    <span class="avatar avatar-lg">
                                                                        <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/14.png" alt="">
                                                                    </span>
                                                                </div>
                                                                <div class="flex-fill">
                                                                    <span class="d-block fw-semibold">
                                                                    ...
                                                                    <span class="d-block text-muted fs-13">0xB3C1A8D0...8921</span>
                                                                </div>
                                                                <div class="text-end">
                                                                    <span class="d-block fw-semibold">1.2 ETH</span>
                                                                    <span class="text-muted fs-13">March 25, 2025, 12:30 PM</span>
                                                                </div>
                                                            </div>
                                                        </li>
                                                    </ul>
                                                ...
                                                <div class="col-xl-12 mt-xxl-0 mt-3">
                                                    <div>
                                                        ...
                                                        <div class="fs-13 mb-4">
                                                            <span class="fw-medium text-muted"><i class="ri-heart-3-fill text-danger align-middle me-2"></i>(2.4k Likes)</span>
                                                        </div>
                                                        <div class="row mb-4">
                                                            ...
                                                            <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-12 mt-xxl-0 mt-3">
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <span class="avatar avatar-xs avatar-rounded lh-1 me-1"><img src="<?php echo $baseUrl; ?>/assets/images/faces/9.jpg" alt=""></span>
                                                                    PixelWarrior
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="mb-4">
                                                            <div class="row justify-content-center">
                                                                ...
                                                                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12 mt-sm-0 mt-3">
                                                                    <div class="nft-assurance">
                                                                        <p class="mb-3">
                                                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"><linearGradient id="a" x1="32" x2="32" y1="63.723" y2=".835" gradientTransform="matrix(1 0 0 -1 0 63.89)" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="var(--primary-color)"/><stop offset="1" stop-color="#2c98b5"/></linearGradient><path fill="var(--primary-color)" d="M53 26V13.4L32 1.9 11 13.4v25.2l21 11.6 21-11.5V33h-2v4.4L32 47.9l-13-7.2V19l12 6.6V45h2V25.6l18-9.9V26h2zm-3.1-12L32 23.9l-11.9-6.6 17.7-10L49.9 14zM35.6 6.1 18 16.2 14.1 14 32 4.1l3.6 2zM17 39.6l-4-2.2V15.7l4 2.2v21.7z"/><linearGradient id="b" x1="35.769" x2="35.769" y1="63.723" y2=".835" gradientTransform="matrix(1 0 0 -1 0 63.89)" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="var(--primary-color)"/><stop offset="1" stop-color="#2c98b5"/></linearGradient><path fill="var(--primary-color)" d="M38 26v2h6c7.2 0 13 5.8 13 13s-5.8 13-13 13H16.4l5.3-5.3-1.4-1.4-7.8 7.7 8.8 7.7 1.3-1.5-6-5.2H44c8.3 0 15-6.7 15-15s-6.7-15-15-15h-6z"/></svg>
                                                                        </p>
                                                                ...
                                                                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12 mt-sm-0 mt-3">
                                                                    <div class="nft-assurance">
                                                                        <p class="mb-3">
                                                                            <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 168 168"><path fill="var(--primary-color)" d="M56 93.534V80.415a1.862 1.862 0 0 1 .473-1.23l12.984-14.73a2.121 2.121 0 0 1 1.596-.705H107v18.13h-3.027a2 2 0 0 0-1.56.75A29.22 29.22 0 0 1 89.9 91.785a1.995 1.995 0 0 0-.937.617l-8.99 10.59a2.299 2.299 0 0 1-3.001.354c-1.639-1.12-1.74-1.597-1.425-3.029a10.313 10.313 0 0 1 2.33-4.47l4.987-5.749a1.998 1.998 0 0 0 .445-1.726l-1.85-8.706a2.869 2.869 0 0 0-1.852-1.834l-9.285-1.814a1.996 1.996 0 0 0-1.873.628l-6.613 7.378a2 2 0 0 0-.51 1.335v5.321a17.844 17.844 0 0 1 4-.846v-3.71l5.343-5.962 7.1 1.387 1.42 6.68-4.333 4.997a15.351 15.351 0 0 0-1.503 2.058A13.993 13.993 0 1 0 81 107.75c0-.206-.022-.406-.03-.61a6.051 6.051 0 0 0 2.051-1.558l8.638-10.174a33.3 33.3 0 0 0 13.256-9.528h2.098A3.998 3.998 0 0 0 111 89.75h12a4.005 4.005 0 0 0 4-4v-24a4.005 4.005 0 0 0-4-4h-12a3.987 3.987 0 0 0-3.444 2H71.053a6.124 6.124 0 0 0-4.597 2.06L53.472 76.54A5.86 5.86 0 0 0 52 80.415v17.407a18.127 18.127 0 0 1 4-4.288zm11 24.216a10 10 0 0 1 0-20 9.884 9.884 0 0 1 4.765 1.228c-.046.172-.094.343-.133.516-.846 3.86.981 5.72 3.075 7.15a6.172 6.172 0 0 0 2.284.955c0 .051.009.1.009.151a10.011 10.011 0 0 1-10 10zm44-56h12v24h-12zm-24.942-17.5a3 3 0 1 0-3-3 3.003 3.003 0 0 0 3 3zm0-4.5a1.5 1.5 0 1 1-1.5 1.5 1.501 1.501 0 0 1 1.5-1.5zm39-20.5a2 2 0 1 0 2 2 2.002 2.002 0 0 0-2-2zm0 3a1 1 0 1 1 1-1 1.001 1.001 0 0 1-1 1zm-64-6a2 2 0 1 0 2 2 2.002 2.002 0 0 0-2-2zm0 3a1 1 0 1 1 1-1 1.001 1.001 0 0 1-1 1zm74 18a2 2 0 1 0 2 2 2.002 2.002 0 0 0-2-2zm0 3a1 1 0 1 1 1-1 1.001 1.001 0 0 1-1 1zm-118 31a2 2 0 1 0-2 2 2.002 2.002 0 0 0 2-2zm-3 0a1 1 0 1 1 1 1 1.001 1.001 0 0 1-1-1z"/><path fill="var(--primary-color)" d="m45.641 41.261 1.487-1.955-.939-.532-.954 2.19h-.032l-.97-2.175-.955.548 1.471 1.909v.031l-2.301-.297v1.064l2.316-.297v.031l-1.486 1.908.891.564 1.018-2.206h.031l.939 2.19.986-.563-1.502-1.878v-.031l2.362.282V40.98l-2.362.312v-.031zM8.834 29.317l-.856 1.099.514.324.586-1.27h.017l.541 1.261.568-.324-.865-1.082v-.018l1.36.163v-.613l-1.36.18v-.018l.856-1.126-.54-.306-.55 1.261h-.018l-.559-1.253-.55.316.848 1.099v.018l-1.325-.171v.613l1.333-.171v.018zM159.058 61.963V60.92l-2.317.307v-.031l1.458-1.918-.921-.522-.936 2.148h-.031l-.951-2.133-.937.538 1.443 1.872v.031l-2.257-.292v1.043l2.272-.291v.031l-1.458 1.872.875.553.998-2.165h.03l.921 2.149.967-.552-1.473-1.842v-.031l2.317.276zM158.501 19.836l1.258-1.655-.794-.45-.808 1.853h-.027l-.82-1.84-.809.464 1.245 1.615v.026l-1.946-.251v.9l1.959-.252v.027l-1.258 1.615.755.477.861-1.867h.026l.795 1.853.834-.476-1.271-1.589v-.027l1.998.239v-.9l-1.998.264v-.026z"/><circle cx="2" cy="135.75" r="2" fill="var(--primary-color)"/><path fill="var(--primary-color)" d="M11 133.75H8a2 2 0 0 0 0 4h3a2 2 0 0 0 0-4zm149 0h-3a2 2 0 0 0 0 4h3a2 2 0 0 0 0-4z"/><circle cx="166" cy="135.75" r="2" fill="var(--primary-color)"/><path fill="var(--primary-color)" d="M118.154 141.75h-8.308a2.006 2.006 0 0 0 0 4h8.308a2.006 2.006 0 0 0 0-4zm-60 0h-8.308a2.006 2.006 0 0 0 0 4h8.308a2.006 2.006 0 0 0 0-4zm45.846 0H64a2 2 0 0 0 0 4h15.94v2H72a2 2 0 0 0 0 4h25a2 2 0 0 0 0-4h-8.94v-2H104a2 2 0 0 0 0-4z"/><path fill="var(--primary-color)" d="M150.721 133.75h-6.932a14 14 0 1 0-19.578 0H17.28a2.017 2.017 0 1 0 0 4H150.72a2.017 2.017 0 1 0 0-4Zm-26.721-10a10 10 0 1 1 10 10 10.011 10.011 0 0 1-10-10Z"/><path fill="var(--primary-color)" d="M26 133.75a2.002 2.002 0 0 1-2-2v-16a2.002 2.002 0 0 1 2-2h16a2.002 2.002 0 0 1 2 2v16a2.002 2.002 0 0 1-2 2h5.65a5.96 5.96 0 0 0 .35-2v-16a6.007 6.007 0 0 0-6-6H26a6.007 6.007 0 0 0-6 6v16a5.96 5.96 0 0 0 .35 2zm66 0a2.002 2.002 0 0 1-2-2v-16a2.002 2.002 0 0 1 2-2h16a2.002 2.002 0 0 1 2 2v16a2.002 2.002 0 0 1-2 2h5.65a5.96 5.96 0 0 0 .35-2v-16a6.007 6.007 0 0 0-6-6H92a6.007 6.007 0 0 0-6 6v16a5.96 5.96 0 0 0 .35 2z"/></svg>
                                                                        </p>
                                                                        <p class="fs-14 fw-medium mb-0">
                                                                            In Auction
                                                                        </p>
                                                        ...
                                                        <div class="mb-4">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-xl-5">
                                                                    <p class="fs-15 fw-medium mb-2 mt-2 mt-xl-0">Features :</p>
                                                                    <ul class="mb-0 ps-3">
                                                                        <li class="text-muted mb-2">
                                                                            <span class="text-default">NFT Title :</span> "Cyber Samurai"
                                                                        </li>
                                                                        <li class="text-muted mb-2">
                                                                            <span class="text-default">Edition :</span> Legendary
                                                                        </li>
                                                                        <li class="text-muted mb-2">
                                                                            <span class="text-default">Material :</span> Neon Armor
                                                                        </li>
                                                                        <li class="text-muted mb-2">
                                                                            <span class="text-default">Sale Date :</span> Mar 10, 2024
                                                                        </li>
                                                                        <li class="text-muted mb-2">
                                                                            <span class="text-default">Average Rating :</span> 4.8/5
                                                                        </li>
                                                                        <li class="text-muted mb-2">
                                                                            <span class="text-default">Background :</span> Futuristic Cityscape
                                                                        </li>
                                                                        <li class="text-muted mb-2">
                                                                            <span class="text-default">Eyes :</span> Cybernetic Glow
                                                                        </li>
                                                                        <li class="text-muted mb-2">
                                                                            <span class="text-default">Country of origin :</span> USA
                                                                        </li>
                                                                        <li class="text-muted">
                                                                            <span class="text-default">Description :</span> A stunning cyberpunk artwork depicting a futuristic samurai with neon armor
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="col-xxl-8 col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-xxl-0 mt-3">
                                                                    <div class="border rounded p-3">
                                                                        <div class="d-sm-flex d-block align-items-top mb-3">
                                                                            <div class="d-flex flex-fill">
                                                                                ...
                                                                                <div class="lh-1 me-2">
                                                                                    ...
                                                                                    <div class="mb-1">
                                                                                        <i class="ri-star-fill text-warning align-middle fs-12"></i>
                                                                                        <i class="ri-star-fill text-warning align-middle fs-12"></i>
                                                                                        <i class="ri-star-fill text-warning align-middle fs-12"></i>
                                                                                        <i class="ri-star-fill text-warning align-middle fs-12"></i>
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <p class="mb-0 fs-12 text-muted">Absolutely stunning! This NFT is a true masterpiece that blends creativity and technology in a way that’s both captivating and unique. I’m beyond excited to own such a one-of-a-kind digital asset. A perfect addition to any collection!</p>
                                                                        </div>
                                                                                ...
                                                                                <div class="col-xl-6">
                                                                                    <div class="products-review-images">
                                                                                        <a href="javascript:void(0);">
                                                                                            <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/44.png" alt="">
                                                                                        </a>
                                                                                        <a href="javascript:void(0);">
                                                                                            <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/18.png" alt="">
                                                                                        </a>
                                                                                    </div>
                                                                                </div>
...
<?php ob_start(); ?>
        ...
        <script src="<?php echo $baseUrl; ?>/assets/js/nft-details.js"></script>

                        ...
                        <div class="col-xl-3">
                            <div class="card custom-card">
                                ...
                                <div class="card-footer d-grid">
                                    <a href="checkout.php" class="btn btn-primary d-inline-flex align-items-center justify-content-center">Proceed to checkout<i class="ti ti-arrow-narrow-right ms-1"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>

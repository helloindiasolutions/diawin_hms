                                        ...
                                        <li class="checkforactive">
                                            <a href="javascript:void(0);" onclick="changeTheInfo(this,'Family Chat &#128525;','17','online')">
                                                <div class="d-flex align-items-top">
                                                    <div class="me-1 lh-1">
                                                        <span class="avatar avatar-md online me-2 avatar-rounded">
                                                            <img src="<?php echo $baseUrl; ?>/assets/images/faces/17.jpg" alt="img">
                                                        </span>
                                                    </div>
                                                    <div class="flex-fill">
                                                        <p class="mb-0 fw-medium" >
                                        ...
                                        <li class="chat-msg-unread checkforactive" >
                                            <a href="javascript:void(0);" onclick="changeTheInfo(this,'Home Team','18','online')">
                                                <div class="d-flex align-items-top">
                                                    <div class="me-1 lh-1">
                                                        <span class="avatar avatar-md online me-2 avatar-rounded">
                                                            <img src="<?php echo $baseUrl; ?>/assets/images/faces/18.jpg" alt="img">
                                                        </span>
                                                    </div>
                                                    <div class="flex-fill">
                                                        <p class="mb-0 fw-medium" >
                                        ...
                                        <li class="chat-inactive checkforactive" >
                                            <a href="javascript:void(0);" onclick="changeTheInfo(this,'Our Tribe &#128526;','19','offline')">
                                                <div class="d-flex align-items-top">
                                                    <div class="me-1 lh-1">
                                                        <span class="avatar avatar-md offline me-2 avatar-rounded">
                                                            <img src="<?php echo $baseUrl; ?>/assets/images/faces/19.jpg" alt="img">
                                                        </span>
                                                    </div>
                                                    <div class="flex-fill">
                                                        <p class="mb-0 fw-medium">
                                        ...
                                        <li class="chat-inactive checkforactive" >
                                            <a href="javascript:void(0);" onclick="changeTheInfo(this,'The Circle','20','offline')">
                                                <div class="d-flex align-items-top">
                                                    <div class="me-1 lh-1">
                                                        <span class="avatar avatar-md offline me-2 avatar-rounded">
                                                            <img  src="<?php echo $baseUrl; ?>/assets/images/faces/20.jpg" alt="img">
                                                        </span>
                                                    </div>
                                                    <div class="flex-fill">
                                                        <p class="mb-0 fw-medium">
                                        ...
                                        <li class="chat-inactive checkforactive" >
                                            <a href="javascript:void(0);" onclick="changeTheInfo(this,'Family Bond','21','offline')">
                                                <div class="d-flex align-items-top">
                                                    <div class="me-1 lh-1">
                                                        <span class="avatar avatar-md offline me-2 avatar-rounded">
                                                            <img src="<?php echo $baseUrl; ?>/assets/images/faces/21.jpg" alt="img">
                                                        </span>
                                                    </div>
                                                    <div class="flex-fill">
                                                        <p class="mb-0 fw-medium">
                        ...
                        <div class="main-chat-area border">
                            <div class="d-flex align-items-center border-bottom main-chat-head flex-wrap gap-1">
                                <div class="me-2 lh-1">
                                    <span class="avatar avatar-md online avatar-rounded chatstatusperson">
                                        <img class="chatimageperson" src="<?php echo $baseUrl; ?>/assets/images/faces/2.jpg" alt="img">
                                    </span>
                                </div>
                                <div class="flex-fill">
                            ...
                            <div class="chat-content" id="main-chat-content">
                                <div class="chat-content-background">
                                    <img src="<?php echo $baseUrl; ?>/assets/images/media/backgrounds/12.png" alt="">
                                </div>
                                    ...
                                    <ul class="shared-files list-unstyled">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-lg">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/files/1.png" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                        ...
                                        <li>
                                            <div class="d-flex align-items-center">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-lg">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/files/2.png" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                        ...
                                        <li>
                                            <div class="d-flex align-items-center">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-lg">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/files/3.png" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                        ...
                                        <li>
                                            <div class="d-flex align-items-center">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-lg">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/files/4.png" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                ...
                                <div class="mb-0">
                                    ...
                                    <div class="row g-2">
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                            <a href="<?php echo $baseUrl; ?>/assets/images/media/media-40.jpg" class="glightbox card mb-0" data-gallery="gallery1">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/media/media-40.jpg" alt="image" >
                                            </a>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                            <a href="<?php echo $baseUrl; ?>/assets/images/media/media-41.jpg" class="glightbox card mb-0" data-gallery="gallery1">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/media/media-41.jpg" alt="image" >
                                            </a>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                            <a href="<?php echo $baseUrl; ?>/assets/images/media/media-42.jpg" class="glightbox card mb-0" data-gallery="gallery1">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/media/media-42.jpg" alt="image" >
                                            </a>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                            <a href="<?php echo $baseUrl; ?>/assets/images/media/media-43.jpg" class="glightbox card mb-0" data-gallery="gallery1">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/media/media-43.jpg" alt="image" >
                                            </a>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                            <a href="<?php echo $baseUrl; ?>/assets/images/media/media-44.jpg" class="glightbox card mb-0" data-gallery="gallery1">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/media/media-44.jpg" alt="image" >
                                            </a>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                            <a href="<?php echo $baseUrl; ?>/assets/images/media/media-45.jpg" class="glightbox card mb-0" data-gallery="gallery1">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/media/media-45.jpg" alt="image" >
                                            </a>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                            <a href="<?php echo $baseUrl; ?>/assets/images/media/media-46.jpg" class="glightbox card mb-0" data-gallery="gallery1">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/media/media-46.jpg" alt="image" >
                                            </a>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                            <a href="<?php echo $baseUrl; ?>/assets/images/media/media-60.jpg" class="glightbox card mb-0" data-gallery="gallery1">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/media/media-60.jpg" alt="image" >
                                            </a>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                            <a href="<?php echo $baseUrl; ?>/assets/images/media/media-61.jpg" class="glightbox card mb-0" data-gallery="gallery1">
...
<?php ob_start(); ?>
        ...
        <!-- Emojji Picker JS -->
        <script src="<?php echo $baseUrl; ?>/assets/libs/fg-emoji-picker/fgEmojiPicker.js"></script>
        
        <!-- Gallery JS -->
        <script src="<?php echo $baseUrl; ?>/assets/libs/glightbox/js/glightbox.min.js"></script>

        <!-- Chat JS -->
        <script src="<?php echo $baseUrl; ?>/assets/js/chat.js"></script>

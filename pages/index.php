...
<?php ob_start(); ?>
                                    ...
                                    <div class="card custom-card shadow-none card-bg-primary overflow-hidden dashboard-banner-card">
                                        <div class="card-body">
                                            <div class="dashboard-banner-card-background">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/media/backgrounds/8.png " alt="">
                                            </div>
                                            <div class="d-flex align-items-center justify-content-between gap-3">
                                                <div>
                                                    ...
                                                    <a href="javascript:void(0)" class="btn btn-secondary btn-wave mt-1">Upgrade To Pro <i class="ti ti-arrow-narrow-right align-middle"></i></a>
                                                </div>
                    ...
                    <!-- Start:: row-2 -->
                    <div class="row">
                        <div class="col-xxl-3 col-md-6 boxed-col-3">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <li class="list-group-item">
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-lg bg-light border border-dashed p-1">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/ecommerce/png/12.png" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                        ...
                                        <li class="list-group-item">
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-lg bg-light border border-dashed p-1">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/ecommerce/png/14.png" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                        ...
                                        <li>
                                            <div class="d-flex align-items-center gap-3 flex-wrap">
                                                ...
                                                <div class="flex-fill">
                                                    ...
                                                    <span class="fs-12 text-muted">janesmith215@gmail.com</span>
                                                </div>
                                                <div class="text-end">
                                        ...
                                        <li>
                                            <div class="d-flex align-items-center gap-3 flex-wrap">
                                                ...
                                                <div class="flex-fill">
                                                    ...
                                                    <span class="fs-12 text-muted">jhondoe431@gmail.com</span>
                                                </div>
                                                <div class="text-end">
                                        ...
                                        <li>
                                            <div class="d-flex align-items-center gap-3 flex-wrap">
                                                ...
                                                <div class="flex-fill">
                                                    ...
                                                    <span class="fs-12 text-muted">aliciakeys986@gmail.com</span>
                                                </div>
                                                <div class="text-end">
                                        ...
                                        <li>
                                            <div class="d-flex align-items-center gap-3 flex-wrap">
                                                ...
                                                <div class="flex-fill">
                                                    ...
                                                    <span class="fs-12 text-muted">leophillip77@gmail.com</span>
                                                </div>
                                                <div class="text-end">
                                        ...
                                        <li>
                                            <div class="d-flex align-items-center gap-3 flex-wrap">
                                                ...
                                                <div class="flex-fill">
                                                    ...
                                                    <span class="fs-12 text-muted text-break">brendasimpson075@gmail.com</span>
                                                </div>
                                                <div class="text-end">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <span class="d-block fw-semibold">Jane Smith</span>
                                                                <span class="fs-12 d-block text-muted">janesmith213@gmail.com</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="avatar-list-stacked">
                                                            <span class="avatar avatar-rounded avatar-sm bg-light">
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/ecommerce/jpg/3.jpg" alt="img">
                                                            </span>
                                                            <span class="avatar avatar-rounded avatar-sm bg-light">
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/ecommerce/jpg/4.jpg" alt="img">
                                                            </span>
                                                            <span class="avatar avatar-rounded avatar-sm bg-light">
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/ecommerce/jpg/5.jpg" alt="img">
                                                            </span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <span class="d-block fw-semibold">Jhon Doe</span>
                                                                <span class="fs-12 d-block text-muted">jhondoe865@gmail.com</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="avatar-list-stacked">
                                                            <span class="avatar avatar-rounded avatar-sm bg-light">
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/ecommerce/jpg/1.jpg" alt="img">
                                                            </span>
                                                            <span class="avatar avatar-rounded avatar-sm bg-light">
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/ecommerce/jpg/2.jpg" alt="img">
                                                            </span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                ...
                                                                <span class="fs-12 d-block text-muted">emileydavis234@gmail.com</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="avatar-list-stacked">
                                                            ...
                                                            <span class="avatar avatar-rounded avatar-sm bg-light">
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/ecommerce/jpg/6.jpg" alt="img">
                                                            </span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <span class="d-block fw-semibold">Leo Phillip</span>
                                                                <span class="fs-12 d-block text-muted">leophillip423@gmail.com</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="border-bottom-0">
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                ...
                                                                <span class="fs-12 d-block text-muted">saralee765@gmail.com</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="border-bottom-0">

                            ...
                            <div class="card-body p-5">
                                ...
                                <div class="row gy-3">
                                    <div class="col-xl-12"> 
                                        ...
                                        <input type="text" class="form-control" id="signup-username" placeholder="Enter User Name" value="Tom Phillip"> 
                                    </div>
                                    <div class="col-xl-12">
                                ...
                                <div class="text-center mt-3 fw-medium">
                                    Already have a account? <a href="sign-in-basic.php" class="text-primary">Login Here</a>
                                </div>
                            </div>
                        </div>
                    </div>

                                    ...
                                    <ul class="list-group list-group-flush nft-list">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                <div>
                                                    <span class="avatar avatar-rounded avatar-sm bg-light p-1">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/34.png" alt="">
                                                    </span>
                                                </div>
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                <div>
                                                    <span class="avatar avatar-rounded avatar-sm bg-light p-1">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/33.png" alt="">
                                                    </span>
                                                </div>
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                <div>
                                                    <span class="avatar avatar-rounded avatar-sm bg-light p-1">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/32.png" alt="">
                                                    </span>
                                                </div>
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                <div>
                                                    <span class="avatar avatar-rounded avatar-sm bg-light p-1">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/28.png" alt="">
                                                    </span>
                                                </div>
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                <div>
                                                    <span class="avatar avatar-rounded avatar-sm bg-light p-1">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/30.png" alt="">
                                                    </span>
                                                </div>
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                <div>
                                                    <span class="avatar avatar-rounded avatar-sm bg-light p-1">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/29.png" alt="">
                                                    </span>
                                                </div>
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-center gap-3">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded p-2 bg-light">
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/22.png" alt="">
                                                            </span>
                                                        </div>
                                                        <div>
                                            ...
                                            <div class="card custom-card nft-wallet">
                                                <div class="card-body p-3">
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-center gap-3">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded p-2 bg-light">
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/23.png" alt="">
                                                            </span>
                                                        </div>
                                                        <div>
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-center gap-3">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded bg-light">
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/20.png" alt="">
                                                            </span>
                                                        </div>
                                                        <div>
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-center gap-3">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded bg-light p-2">
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/24.png" alt="">
                                                            </span>
                                                        </div>
                                                        <div>
                                            ...
                                            <div class="card custom-card nft-wallet">
                                                <div class="card-body p-3">
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-center gap-3">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded bg-light p-2">
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/19.png" alt="">
                                                            </span>
                                                        </div>
                                                        <div>
                                            ...
                                            <div class="card custom-card nft-wallet">
                                                <div class="card-body p-3">
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-center gap-3">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded bg-light">
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/27.png" alt="">
                                                            </span>
                                                        </div>
                                                        <div>

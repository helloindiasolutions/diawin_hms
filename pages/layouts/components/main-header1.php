					...
					<ul class="header-content-right">
							...
							<div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
								<div class="p-3 bg-primary text-fixed-white">
									<div class="d-flex align-items-center justify-content-between">
										...
										<a href="products.php" class="text-fixed-white text-decoration-underline fs-12">Continue Shopping <i class="ti ti-arrow-narrow-right"></i></a>
									</div>
								</div>
								...
								<ul class="list-unstyled mb-0" id="header-cart-items-scroll">
										...
										<div class="d-flex align-items-start cart-dropdown-item gap-3">
											<div class="lh-1">
												<span class="avatar avatar-xl bg-gray-300">
													<img src="<?php echo $baseUrl; ?>/assets/images/ecommerce/png/13.png" alt="img">
												</span>
											</div>
												...
												<div class="d-flex align-items-start justify-content-between mb-3">
													<div class="fs-14 fw-medium w-75">
														<div class="text-truncate">
															<a href="cart.php">Urban Chic Satchel</a>
														</div>
									...
									<li class="dropdown-item">
										<div class="d-flex align-items-start cart-dropdown-item gap-3">
											<div class="lh-1">
												<span class="avatar avatar-xl bg-gray-300">
													<img src="<?php echo $baseUrl; ?>/assets/images/ecommerce/png/15.png" alt="img">
												</span>
											</div>
											<div class="flex-fill w-75">
												<div class="d-flex align-items-start justify-content-between mb-3">
													<div class="fs-14 fw-medium w-75">
														<div class="text-truncate">
															<a href="cart.php">TrailBlaze Runners</a>
														</div>
														<div class="fs-11 text-muted text-truncate">
									...
									<li class="dropdown-item">
										<div class="d-flex align-items-start cart-dropdown-item gap-3">
											<div class="lh-1">
												<span class="avatar avatar-xl bg-gray-300">
													<img src="<?php echo $baseUrl; ?>/assets/images/ecommerce/png/19.png" alt="img">
												</span>
											</div>
											<div class="flex-fill w-75">
												<div class="d-flex align-items-start justify-content-between mb-3">
													<div class="fs-14 fw-medium w-75">
														<div class="text-truncate">
															<a href="cart.php">VisionTech SLR</a>
														</div>
														<div class="fs-11 text-muted text-truncate">
									...
									<li class="dropdown-item">
										<div class="d-flex align-items-start cart-dropdown-item gap-3">
											<div class="lh-1">
												<span class="avatar avatar-xl bg-gray-300">
													<img src="<?php echo $baseUrl; ?>/assets/images/ecommerce/png/6.png" alt="img">
												</span>
											</div>
											<div class="flex-fill w-75">
												<div class="d-flex align-items-start justify-content-between mb-3">
													<div class="fs-14 fw-medium w-75">
														<div class="text-truncate">
															<a href="cart.php">FlexiSeat Office Chair</a>
														</div>
														<div class="fs-11 text-muted text-truncate">
									...
									<li class="dropdown-item">
										<div class="d-flex align-items-start cart-dropdown-item gap-3">
											<div class="lh-1">
												<span class="avatar avatar-xl bg-gray-300">
													<img src="<?php echo $baseUrl; ?>/assets/images/ecommerce/png/11.png" alt="img">
												</span>
											</div>
											<div class="flex-fill w-75">
												<div class="d-flex align-items-start justify-content-between mb-3">
													<div class="fs-14 fw-medium w-75">
														<div class="text-truncate">
															<a href="cart.php">DecoDial Classic</a>
														</div>
														<div class="fs-11 text-muted text-truncate">
								...
								<div class="p-3 empty-header-item border-top">
									<div class="text-center d-grid">
										<a href="checkout.php" class="btn btn-primary btn-wave">Proceed to checkout</a>
									</div>
								</div>
							...
							<div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
								...
								<ul class="list-unstyled mb-0" id="header-notification-scroll">
									<li class="dropdown-item position-relative">
										<a href="chat.php" class="stretched-link"></a>
						...
						<li class="header-element dropdown">
							...
							<a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
								<div>
									<img src="<?php echo $baseUrl; ?>/assets/images/faces/12.jpg" alt="img" class="header-link-icon">
								</div>
							</a>
							<!-- End::header-link|dropdown-toggle -->
								...
								<ul class="list-unstyled mb-0">
									<li>
										<ul class="list-unstyled mb-0 sub-list">
											<li>
												<a class="dropdown-item d-flex align-items-center" href="profile.php"><i class="ti ti-user-circle me-2 fs-18"></i>View Profile</a>
											</li>
											<li>
												<a class="dropdown-item d-flex align-items-center" href="mail-settings.php"><i class="ti ti-settings-cog me-2 fs-18"></i>Account Settings</a>
											</li>
										</ul>        
									</li>
									<li>
									...
									<li><a class="dropdown-item d-flex align-items-center" href="sign-in-cover.php"><i class="ti ti-logout me-2 fs-18"></i>Log Out</a></li>
								</ul>
							</div>
						</li>  
						<!-- End::header-element -->

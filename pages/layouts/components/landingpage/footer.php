        ...
        <section class="section landing-footer text-fixed-white">
            <div class="container">
                ...
                <div class="row justify-content-center gy-3">
                    <div class="col-xl-4">
                        <p class="fw-semibold mb-3 brand-image"><a href="index.php"><img src="<?php echo $baseUrl; ?>/assets/images/brand-logos/desktop-dark.png" alt=""></a></p>
                    ...
                    <div class="col-sm-3 col-xl-2 col-6">
                        ...
                        <ul class="list-unstyled fw-normal landing-footer-list mb-0">
                            ...
                            <li>
                                <a href="pricing.php" class="text-fixed-white op-6">Pricing</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-sm-3 col-xl-2 col-6">
                    ...
                    <div class="col-sm-3 col-xl-2 col-6">
                        ...
                        <ul class="list-unstyled fw-normal landing-footer-list mb-0">
                            <li>
                                <a href="blog.php" class="text-fixed-white op-6">Blog</a>
                            </li>
                            <li>
                ...
                <div class="row">
                    <div class="col-lg-4 text-lg-start text-center">
                        <span class="text-fixed-white op-7 fs-14"> © Copyright <span id="year"></span> <a
                            href="https://spruko.com/" class="text-primary fs-15 fw-semibold" target="_blank">Spruko </a> .All rights reserved
                        </span>
                    </div>

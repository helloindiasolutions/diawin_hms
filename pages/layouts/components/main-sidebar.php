						...
						<ul class="main-menu">
							...
							<li class="slide has-sub">
								...
								<ul class="slide-menu child1">
									...
									<li class="slide">
										<a href="index1.php" class="side-menu__item">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="index2.php" class="side-menu__item">Dashboard</a>
											</li>
											<li class="slide">
											...
											<li class="slide">
												<a href="customers-list.php" class="side-menu__item">Customers</a>
											</li>
											<li class="slide">
												<a href="orders.php" class="side-menu__item">Orders</a>
											</li>
											<li class="slide">
												<a href="orders-details.php" class="side-menu__item">Order Details</a>
											</li>
											<li class="slide">
												<a href="add-product.php" class="side-menu__item">Add Product</a>
											</li>
										</ul>    
									</li>
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="index4.php" class="side-menu__item">Dashboard</a>
											</li>
											<li class="slide">
												<a href="crypto-transactions.php" class="side-menu__item">Transactions</a>
											</li>
											<li class="slide">
												<a href="crypto-currency-exchange.php" class="side-menu__item">Exchange</a>
											</li>
											<li class="slide">
												<a href="crypto-buy-sell.php" class="side-menu__item">Buy & Sell</a>
											</li>
											<li class="slide">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="index3.php" class="side-menu__item">Dashboard</a>
											</li>
											<li class="slide">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="index6.php" class="side-menu__item">Dashboard</a>
											</li>
											<li class="slide">
									...
									<li class="slide">
										<a href="index8.php" class="side-menu__item">
									...
									<li class="slide">
										<a href="index9.php" class="side-menu__item">
									...
									<li class="slide">
										<a href="index10.php" class="side-menu__item">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="index5.php" class="side-menu__item">Dashboard</a>
											</li>
											<li class="slide">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="index7.php" class="side-menu__item">Dashboard</a>
											</li>
											<li class="slide">
									...
									<li class="slide">
										<a href="index13.php" class="side-menu__item">
									...
									<li class="slide">
										<a href="index15.php" class="side-menu__item">
									...
									<li class="slide">
										<a href="index14.php" class="side-menu__item">
									...
									<li class="slide">
										<a href="index11.php" class="side-menu__item">
									...
									<li class="slide">
										<a href="index12.php" class="side-menu__item">
							...
							<li class="slide has-sub">
								...
								<ul class="slide-menu child1">
									...
									<li class="slide">
										<a href="full-calendar.php" class="side-menu__item">
									...
									<li class="slide">
										<a href="sweet-alerts.php" class="side-menu__item">
									...
									<li class="slide">
										<a href="to-do-list.php" class="side-menu__item">
							...
							<li class="slide has-sub">
								...
								<ul class="slide-menu child1 pages-ul">
									...
									<li class="slide">
										<a href="emptypage.php" class="side-menu__item">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="form-advanced.php" class="side-menu__item">Form Advanced</a>
											</li>
											<li class="slide has-sub">
												...
												<ul class="slide-menu child3">
													<li class="slide">
														<a href="form-inputs.php" class="side-menu__item">Inputs</a>
													</li>
													<li class="slide">
														<a href="form-check-radios.php" class="side-menu__item">Checks & Radios</a>
													</li>
													<li class="slide">
														<a href="form-input-group.php" class="side-menu__item">Input Group</a>
													</li>
													<li class="slide">
														<a href="form-select.php" class="side-menu__item">Form Select</a>
													</li>
													<li class="slide">
														<a href="form-range.php" class="side-menu__item">Range Slider</a>
													</li>
													<li class="slide">
														<a href="form-input-masks.php" class="side-menu__item">Input Masks</a>
													</li>
													<li class="slide">
														<a href="form-file-uploads.php" class="side-menu__item">File Uploads</a>
													</li>
													<li class="slide">
														<a href="form-datetime-pickers.php" class="side-menu__item">Date,Time Picker</a>
													</li>
													<li class="slide">
														<a href="form-color-pickers.php" class="side-menu__item">Color Pickers</a>
													</li>
												</ul>
											</li>
											<li class="slide">
												<a href="floating-labels.php" class="side-menu__item">Floating Labels</a>
											</li>
											<li class="slide">
												<a href="form-layout.php" class="side-menu__item">Form Layouts</a>
											</li>
											<li class="slide">
												<a href="form-wizards.php" class="side-menu__item">Form Wizards</a>
											</li>
											<li class="slide">
												<a href="quill-editor.php" class="side-menu__item">Quill Editor</a>
											</li>
											<li class="slide">
												<a href="form-validation.php" class="side-menu__item">Validation</a>
											</li>
											<li class="slide">
												<a href="form-select2.php" class="side-menu__item">Select2</a>
											</li>
										</ul>
									</li>
									<li class="slide">
									...
									<li class="slide">
										<a href="landing.php" class="side-menu__item">
									...
									<li class="slide">
										<a href="testimonials.php" class="side-menu__item">
									...
									<li class="slide">
										<a href="search-results.php" class="side-menu__item">
									...
									<li class="slide">
										<a href="terms-conditions.php" class="side-menu__item">
											<svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"/><polygon points="152 32 152 88 208 88 152 32" opacity="0.2"/><path d="M200,224H56a8,8,0,0,1-8-8V40a8,8,0,0,1,8-8h96l56,56V216A8,8,0,0,1,200,224Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/><polyline points="152 32 152 88 208 88" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/><line x1="96" y1="136" x2="160" y2="136" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/><line x1="96" y1="168" x2="160" y2="168" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/></svg>
											Terms & Conditions</a>
									</li>
									<li class="slide">
										<a href="timeline.php" class="side-menu__item">
							...
							<li class="slide has-sub">
								...
								<ul class="slide-menu child1">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="accordions-collpase.php" class="side-menu__item">Accordions & Collapse</a>
											</li>
											<li class="slide">
											...
											<li class="slide">
												<a href="media-player.php" class="side-menu__item">Media Player</a>
											</li>
											<li class="slide">
												<a href="modals-closes.php" class="side-menu__item">Modals & Closes</a>
											</li>
											<li class="slide">
											...
											<li class="slide">
												<a href="ribbons.php" class="side-menu__item">Ribbons</a>
											</li>
											<li class="slide">
												<a href="scrollspy.php" class="side-menu__item">Scrollspy</a>
											</li>
											<li class="slide">
												<a href="sortable-list.php" class="side-menu__item">Sortable JS</a>
											</li>
											<li class="slide">
												<a href="swiperjs.php" class="side-menu__item">Swiper JS</a>
											</li>
											<li class="slide">
												<a href="tour.php" class="side-menu__item">Tour</a>
											</li>
										</ul>
									</li>
								</ul>
							...
							<li class="slide has-sub">
								...
								<ul class="slide-menu child1">
									...
									<li class="slide">
										<a href="vector-maps.php" class="side-menu__item">
									...
									<li class="slide">
										<a href="leaflet-maps.php" class="side-menu__item">
									...
									<li class="slide">
										<a href="google-maps.php" class="side-menu__item">
							...
							<li class="slide has-sub">
								...
								<ul class="slide-menu child1">
									...
									<li class="slide">
										<a href="chartjs-charts.php" class="side-menu__item">
									...
									<li class="slide">
										<a href="echarts.php" class="side-menu__item">
							...
							<li class="slide has-sub">
								...
								<ul class="slide-menu child1"> 
									...
									<li class="slide">
										<a href="tables.php" class="side-menu__item">
								...
								<ul class="slide-menu child1 doublemenu_slide-menu">
									<li class="text-center p-3 text-fixed-white">
										<div class="doublemenu_slide-menu-background">
											<img src="<?php echo $baseUrl; ?>/assets/images/media/backgrounds/13.png" alt="">
										</div>
										<div class="d-flex flex-column align-items-center justify-content-between h-100">
											<div class="fs-15 fw-medium">Dashboard AI Helper</div>
											<div>
												<span class="avatar avatar-lg p-1">
													<img src="<?php echo $baseUrl; ?>/assets/images/media/media-80.png" alt="">

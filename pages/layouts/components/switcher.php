                                ...
                                <div class="d-flex flex-wrap align-items-center switcher-style">
                                    <div class="form-check switch-select menu-img-select m-2">
                                        ...
                                        <div class="bg-img-container">
                                            <img src="<?php echo $baseUrl; ?>/assets/images/menu-bg-images/bg-img1.jpg" alt="">
                                        </div>
                                    </div>
                                    <div class="form-check switch-select menu-img-select m-2">
                                        ...
                                        <div class="bg-img-container">
                                            <img src="<?php echo $baseUrl; ?>/assets/images/menu-bg-images/bg-img2.jpg" alt="">
                                        </div>
                                    </div>
                                    <div class="form-check switch-select menu-img-select m-2">
                                        <input class="form-check-input bgimage-input bg-img3" type="radio" name="menu-background"
                                            id="switcher-bg-img2">
                                        <div class="bg-img-container">
                                            <img src="<?php echo $baseUrl; ?>/assets/images/menu-bg-images/bg-img3.jpg" alt="">
                                        </div>
                                    </div>
                                    <div class="form-check switch-select menu-img-select m-2">
                                        ...
                                        <div class="bg-img-container">
                                            <img src="<?php echo $baseUrl; ?>/assets/images/menu-bg-images/bg-img4.jpg" alt="">
                                        </div>
                                    </div>
                                    <div class="form-check switch-select menu-img-select m-2">
                                        ...
                                        <div class="bg-img-container">
                                            <img src="<?php echo $baseUrl; ?>/assets/images/menu-bg-images/bg-img5.jpg" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>

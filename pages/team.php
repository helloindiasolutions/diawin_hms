...
<?php ob_start(); ?>
                    ...
                    <div class="row row-cols-xxl-5 row-cols-xl-4 row-cols-lg-3 row-cols-md-3 row-cols-sm-2 row-cols-1">
                        ...
                        <div class="col">
                            <div class="card custom-card">
                                <img src="<?php echo $baseUrl; ?>/assets/images/faces/team/5.png" class="card-img-top" alt="...">
                                <div class="card-body text-center">
                                    <h6 class="fw-semibold mb-0">
                                        Anna Martinez
                                    </h6>
                                    <span class="text-muted fs-13">UX/UI Designer </span>
                                    <div class="btn-list mt-3">
                                        <button class="btn btn-light btn-icon rounded-circle border">
                                            <i class="ri-facebook-circle-fill lh-1"></i>
                                        </button>
                        ...
                        <div class="col">
                            <div class="card custom-card">
                                <img src="<?php echo $baseUrl; ?>/assets/images/faces/team/6.png" class="card-img-top" alt="...">
                                <div class="card-body text-center">
                                    <h6 class="fw-semibold mb-0">
                                        James Taylor
                                    </h6>
                                    <span class="text-muted fs-13">Project Manager</span>
                                    <div class="btn-list mt-3">
                                        <button class="btn btn-light btn-icon rounded-circle border">
                                            <i class="ri-facebook-circle-fill lh-1"></i>
                                        </button>
                        ...
                        <div class="col">
                            <div class="card custom-card">
                                <img src="<?php echo $baseUrl; ?>/assets/images/faces/team/7.png" class="card-img-top" alt="...">
                                <div class="card-body text-center">
                                    <h6 class="fw-semibold mb-0">
                                        Olivia Harris
                                    </h6>
                                    <span class="text-muted fs-13">Content Strategist</span>
                                    <div class="btn-list mt-3">
                                        <button class="btn btn-light btn-icon rounded-circle border">
                                            <i class="ri-facebook-circle-fill lh-1"></i>
                                        </button>
                        ...
                        <div class="col">
                            <div class="card custom-card">
                                <img src="<?php echo $baseUrl; ?>/assets/images/faces/team/8.png" class="card-img-top" alt="...">
                                <div class="card-body text-center">
                                    <h6 class="fw-semibold mb-0">
                                        Daniel Lee
                                    </h6>
                        ...
                        <div class="col">
                            <div class="card custom-card">
                                <img src="<?php echo $baseUrl; ?>/assets/images/faces/team/9.png" class="card-img-top" alt="...">
                                <div class="card-body text-center">
                                    <h6 class="fw-semibold mb-0">
                                        Mia White
                                    </h6>
                                    <span class="text-muted fs-13">QA Engineer</span>
                                    <div class="btn-list mt-3">
                                        <button class="btn btn-light btn-icon rounded-circle border">
                                            <i class="ri-facebook-circle-fill lh-1"></i>
                                        </button>
                        ...
                        <div class="col">
                            <div class="card custom-card">
                                <img src="<?php echo $baseUrl; ?>/assets/images/faces/team/10.png" class="card-img-top" alt="...">
                                <div class="card-body text-center">
                                    <h6 class="fw-semibold mb-0">
                                        Ethan Scott
                                    </h6>
                                    <span class="text-muted fs-13">Digital Marketing Lead</span>
                                    <div class="btn-list mt-3">
                                        <button class="btn btn-light btn-icon rounded-circle border">
                                            <i class="ri-facebook-circle-fill lh-1"></i>
                                        </button>

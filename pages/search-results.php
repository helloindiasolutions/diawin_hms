                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="d-flex align-items-start gap-3 flex-wrap">
                                                                <div>
                                                                    <figure class="figure mb-0">
                                                                        <a class="avatar avatar-search" href="javascript:void(0);">
                                                                            <img class="img-fluid rounded card-img" src="<?php echo $baseUrl; ?>/assets/images/media/media-59.jpg" alt="...">
                                                                        </a>
                                                                ...
                                                                <div>
                                                                    <figure class="figure mb-0">
                                                                        <a class="avatar avatar-search" href="javascript:void(0);">
                                                                            <img class="img-fluid rounded card-img" src="<?php echo $baseUrl; ?>/assets/images/media/media-60.jpg" alt="...">
                                                                        </a>
                                                                        <a href="javascript:void(0)" class="d-block">
                                                                            Active Living
                                                                        </a>
                                                                ...
                                                                <div>
                                                                    <figure class="figure mb-0">
                                                                        <a class="avatar avatar-search" href="javascript:void(0);">
                                                                            <img class="img-fluid rounded card-img" src="<?php echo $baseUrl; ?>/assets/images/media/media-61.jpg" alt="...">
                                                                        </a>
                                                                        <a href="javascript:void(0)" class="d-block">
                                                                            Creative Elegance
                                                                        </a>
                                ...
                                <div class="tab-pane border-0 p-0" id="search-images" role="tabpanel">
                                    <div class="row">
                                        <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                            <a href="<?php echo $baseUrl; ?>/assets/images/media/media-40.jpg" class="glightbox card search-images-card" data-gallery="gallery1">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                            <a href="<?php echo $baseUrl; ?>/assets/images/media/media-41.jpg" class="glightbox card search-images-card" data-gallery="gallery1">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                            <a href="<?php echo $baseUrl; ?>/assets/images/media/media-42.jpg" class="glightbox card search-images-card" data-gallery="gallery1">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                            <a href="<?php echo $baseUrl; ?>/assets/images/media/media-43.jpg" class="glightbox card search-images-card" data-gallery="gallery1">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                            <a href="<?php echo $baseUrl; ?>/assets/images/media/media-44.jpg" class="glightbox card search-images-card" data-gallery="gallery1">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                            <a href="<?php echo $baseUrl; ?>/assets/images/media/media-45.jpg" class="glightbox card search-images-card" data-gallery="gallery1">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/media/media-45.jpg" alt="image" >
                                                <div class="p-2">
                                                    <div class="d-flex align-items-center gap-1">
                                                        <div class="avatar avatar-xs">
                                                            <img src="<?php echo $baseUrl; ?>/assets/images/company-logos/7.png" alt="">
                                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                            <a href="<?php echo $baseUrl; ?>/assets/images/media/media-46.jpg" class="glightbox card search-images-card" data-gallery="gallery1">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                            <a href="<?php echo $baseUrl; ?>/assets/images/media/media-60.jpg" class="glightbox card search-images-card" data-gallery="gallery1">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/media/media-60.jpg" alt="image" >
                                                <div class="p-2">
                                                    <div class="d-flex align-items-center gap-1">
                                                        <div class="avatar avatar-xs">
                                                            <img src="<?php echo $baseUrl; ?>/assets/images/company-logos/9.png" alt="">
                                                        </div>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <div>
                                                                <span class="avatar avatar-lg avatar-rounded bg-primary bg-opacity-10 border">
                                                                    <img src="<?php echo $baseUrl; ?>/assets/images/media/books/6.jpg" alt="">
                                                                </span>
                                                            </div>
                                                            <div class="ms-2">
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex align-items-start flex-wrap gap-3 justify-content-between">
                                                        <div class="d-flex align-items-center">
                                                            <div>
                                                                <span class="avatar avatar-lg avatar-rounded bg-primary bg-opacity-10 border">
                                                                    <img src="<?php echo $baseUrl; ?>/assets/images/media/books/1.jpg" alt="">
                                                                </span>
                                                            </div>
                                                            <div class="ms-2">
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex align-items-start flex-wrap gap-3 justify-content-between">
                                                        <div class="d-flex align-items-center">
                                                            <div>
                                                                <span class="avatar avatar-lg avatar-rounded bg-primary bg-opacity-10 border">
                                                                    <img src="<?php echo $baseUrl; ?>/assets/images/media/books/2.jpg" alt="">
                                                                </span>
                                                            </div>
                                                            <div class="ms-2">
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex align-items-start flex-wrap gap-3 justify-content-between">
                                                        <div class="d-flex align-items-center">
                                                            <div>
                                                                <span class="avatar avatar-lg avatar-rounded bg-primary bg-opacity-10 border">
                                                                    <img src="<?php echo $baseUrl; ?>/assets/images/media/books/3.jpg" alt="">
                                                                </span>
                                                            </div>
                                                            <div class="ms-2">
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex align-items-start flex-wrap gap-3 justify-content-between">
                                                        <div class="d-flex align-items-center">
                                                            <div>
                                                                <span class="avatar avatar-lg avatar-rounded bg-primary bg-opacity-10 border">
                                                                    <img src="<?php echo $baseUrl; ?>/assets/images/media/books/4.jpg" alt="">
                                                                </span>
                                                            </div>
                                                            <div class="ms-2">
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex align-items-start flex-wrap gap-3 justify-content-between">
                                                        <div class="d-flex align-items-center">
                                                            <div>
                                                                <span class="avatar avatar-lg avatar-rounded bg-primary bg-opacity-10 border">
                                                                    <img src="<?php echo $baseUrl; ?>/assets/images/media/books/5.jpg" alt="">
                                                                </span>
                                                            </div>
                                                            <div class="ms-2">
...
<?php ob_start(); ?>
        ...
        <script src="<?php echo $baseUrl; ?>/assets/js/search-results.js"></script>

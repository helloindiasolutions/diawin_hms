                                    ...
                                    <ul class="list-group list-group-flush">
                                            ...
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-md avatar-rounded bg-light">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/faces/doctors/1.png" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                                    <span class="d-block fw-semibold">Dr. John Miller</span>
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-md avatar-rounded bg-light">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/faces/doctors/4.png" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                                    <span class="d-block fw-semibold">Dr. Sarah Williams</span>
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-md avatar-rounded bg-light">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/faces/doctors/2.png" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                                    <span class="d-block fw-semibold">Dr. Mark Thompson</span>
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-md avatar-rounded bg-light">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/faces/doctors/5.png" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                                    <span class="d-block fw-semibold">Dr. Emily Davis</span>
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-md avatar-rounded bg-light">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/faces/doctors/3.png" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                                    <span class="d-block fw-semibold">Dr. James Clark</span>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="lh-1">
                                                                <span class="avatar avatar-sm avatar-rounded bg-light">
                                                                    <img src="<?php echo $baseUrl; ?>/assets/images/faces/doctors/6.png" alt="">
                                                                </span>
                                                            </div>
                                                            <div>
                                                                Dr. Martinez
...
<?php ob_start(); ?>
        ...
        <!-- Medical Dashboard --> 
        <script src="<?php echo $baseUrl; ?>/assets/js/medical-dashboard.js"></script>

                                    ...
                                    <div class="d-flex align-items-center gap-2 mb-4 flex-wrap pos-category pos-categories-list" id="filter">
                                        <div class="nft-tag nft-tag-primary active">
                                            <a href="javascript:void(0);" class="stretched-link categories" data-filter="*">
                                                <span class="nft-tag-icon">
                                                    <img src="<?php echo $baseUrl; ?>/assets/images/pos-system/20.png" alt="">
                                                </span>
                                        ...
                                        <div class="nft-tag nft-tag-secondary">
                                            <a href="javascript:void(0);" class="stretched-link categories" data-filter=".Appetizers">
                                                <span class="nft-tag-icon">
                                                    <img src="<?php echo $baseUrl; ?>/assets/images/pos-system/1.png" alt="">
                                                </span>
                                        ...
                                        <div class="nft-tag nft-tag-info">
                                            <a href="javascript:void(0);" class="stretched-link categories" data-filter=".Main-Course">
                                                <span class="nft-tag-icon">
                                                    <img src="<?php echo $baseUrl; ?>/assets/images/pos-system/2.png" alt="">
                                                </span>
                                        ...
                                        <div class="nft-tag nft-tag-success">
                                            <a href="javascript:void(0);" class="stretched-link categories" data-filter=".Beverages">
                                                <span class="nft-tag-icon">
                                                    <img src="<?php echo $baseUrl; ?>/assets/images/pos-system/3.png" alt="">
                                                </span>
                                        ...
                                        <div class="nft-tag nft-tag-danger">
                                            <a href="javascript:void(0);" class="stretched-link categories" data-filter=".Desserts">
                                                <span class="nft-tag-icon">
                                                    <img src="<?php echo $baseUrl; ?>/assets/images/pos-system/4.png" alt="">
                                                </span>
                                        ...
                                        <div class="nft-tag nft-tag-warning">
                                            <a href="javascript:void(0);" class="stretched-link categories" data-filter=".Soups">
                                                <span class="nft-tag-icon">
                                                    <img src="<?php echo $baseUrl; ?>/assets/images/pos-system/6.png" alt="">
                                                </span>
                                        ...
                                        <div class="nft-tag nft-tag-purple">
                                            <a href="javascript:void(0);" class="stretched-link categories" data-filter=".Salads">
                                                <span class="nft-tag-icon">
                                                    <img src="<?php echo $baseUrl; ?>/assets/images/pos-system/5.png" alt="">
                                                </span>
                                    ...
                                    <div class="row list-wrapper">
                                        <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 card-item Soups" data-category="Soups">
                                            <div class="card custom-card">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/pos-system/16.png" class="card-img-top bg-light" alt="...">
                                                <div class="card-body">
                                                    <div class="mb-1">
                                        ...
                                        <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 card-item Salads" data-category="Salads">
                                            <div class="card custom-card out-of-stock">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/pos-system/17.png" class="card-img-top bg-light" alt="...">
                                                <div class="card-body">
                                                    <div class="mb-1">
                                        ...
                                        <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 card-item Desserts" data-category="Desserts">
                                            <div class="card custom-card">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/pos-system/19.png" class="card-img-top bg-light" alt="...">
                                                <div class="card-body">
                                                    <div class="mb-1">
                                        ...
                                        <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 card-item Salads" data-category="Salads">
                                            <div class="card custom-card">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/pos-system/18.png" class="card-img-top bg-light" alt="...">
                                                <div class="card-body">
                                                    <div class="mb-1">
                                        ...
                                        <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 card-item Beverages" data-category="Beverages">
                                            <div class="card custom-card">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/pos-system/11.png" class="card-img-top bg-light" alt="...">
                                                <div class="card-body">
                                                    <div class="mb-1">
                                        ...
                                        <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 card-item Soups" data-category="Soups">
                                            <div class="card custom-card">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/pos-system/15.png" class="card-img-top bg-light" alt="...">
                                                <div class="card-body">
                                                    <div class="mb-1">
                                        ...
                                        <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 card-item Appetizers" data-category="Appetizers">
                                            <div class="card custom-card">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/pos-system/8.png" class="card-img-top bg-light" alt="...">
                                                <div class="card-body">
                                                    <div class="mb-1">
                                        ...
                                        <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 card-item Desserts" data-category="Desserts">
                                            <div class="card custom-card">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/pos-system/13.png" class="card-img-top bg-light" alt="...">
                                                <div class="card-body">
                                                    <div class="mb-1">
                                                        <a href="javascript:void(0);" class="fw-medium fs-16">Frosty Dream Parfait</a>
                                                    </div>
                                        ...
                                        <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 card-item Main-Course" data-category="Main-Course">
                                            <div class="card custom-card">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/pos-system/10.png" class="card-img-top bg-light" alt="...">
                                                <div class="card-body">
                                                    <div class="mb-1">
                                        ...
                                        <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 card-item Desserts" data-category="Desserts">
                                            <div class="card custom-card">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/pos-system/14.png" class="card-img-top bg-light" alt="...">
                                                <div class="card-body">
                                                    <div class="mb-1">
                                        ...
                                        <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 card-item Appetizers" data-category="Appetizers">
                                            <div class="card custom-card">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/pos-system/7.png" class="card-img-top bg-light" alt="...">
                                                <div class="card-body">
                                                    <div class="mb-1">
                                        ...
                                        <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 card-item Main-Course" data-category="Main-Course">
                                            <div class="card custom-card">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/pos-system/9.png" class="card-img-top bg-light" alt="...">
                                                <div class="card-body">
                                                    <div class="mb-1">
                                    ...
                                    <ul class="list-unstyled pos-system-orders-list">
                                            ...
                                            <div class="d-flex align-items-start gap-2 flex-wrap">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-lg bg-light border">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/pos-system/13.png" alt="img">
                                                    </span>
                                                </div>
                                        ...
                                        <li>
                                            <div class="d-flex align-items-start gap-2 flex-wrap">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-lg bg-light border">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/pos-system/18.png" alt="img">
                                                    </span>
                                                </div>
                                                <div class="flex-grow-1">
                                                    <div class="d-flex align-items-end mb-1 flex-wrap">
                                        ...
                                        <li>
                                            <div class="d-flex align-items-start gap-2 flex-wrap">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-lg bg-light border">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/pos-system/9.png" alt="img">
                                                    </span>
                                                </div>
                                                <div class="flex-grow-1">
                                                    <div class="d-flex align-items-end mb-1 flex-wrap">
                                        ...
                                        <li>
                                            <div class="d-flex align-items-start gap-2 flex-wrap">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-lg bg-light border">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/pos-system/12.png" alt="img">
                                                    </span>
                                                </div>
                                                <div class="flex-grow-1">
                                                    <div class="d-flex align-items-end mb-1 flex-wrap">
...
<?php ob_start(); ?>
        ...
        <!-- Isotope-layout JS -->
        <script src="<?php echo $baseUrl; ?>/assets/libs/isotope-layout/isotope.pkgd.min.js"></script>

        <!-- Swiper JS -->
        <script src="<?php echo $baseUrl; ?>/assets/libs/swiper/swiper-bundle.min.js"></script>

        <!-- Internal POS-Dashboard JS -->
        <script src="<?php echo $baseUrl; ?>/assets/js/pos-dashboard.js"></script>

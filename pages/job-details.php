                        ...
                        <div class="col-xl-9">
                                    ...
                                    <div class="d-flex flex-wrap align-items-top justify-content-between gap-2">
                                        <div>
                                            <div class="d-flex flex-wrap gap-3">
                                                ...
                                                <div>
                                                    <h4 class="fw-medium mb-2 d-flex align-items-center"><a href="javascript:void(0);">Software Developer</a></h4>
                                                    <a href="javascript:void(0);"><i class="bi bi-building"></i>Tech Solutions Inc.</a>
                                                    <div class="d-flex fs-14 mt-4 flex-wrap flex-sm-nowrap">
                                                        <div>
                                                            <p class="mb-2"><i class="bi bi-geo-alt me-2"></i>New York, NY (Hybrid: 3 days in office, 2 days remote)</p>
                                                            <p><i class="bi bi-briefcase me-2"></i>2+ years in software development</p>
                                                        </div>
                                                        <div class="ms-0 ms-sm-4">
                                                            <p class="mb-2"><i class="bi bi-coin me-2"></i><span class="fw-medium">$80,000 - $110,000 per year (depending on experience)</p>
                                                            <p><i class="bi bi-mortarboard  me-2"></i>Development Team</p>
                                                        </div>
                                                    </div>
                            ...
                            <div class="card custom-card">
                                <div class="card-body">
                                    ...
                                    <p class="op-9">We are looking for a skilled and passionate Software Developer to join our dynamic development team. As a Software Developer, you will play a crucial role in designing, developing, and maintaining our core software applications and systems. You will collaborate with cross-functional teams to create innovative solutions that meet the needs of our clients.</p>
                                    <div class="row gy-3">
                                        <div class="col-xl-6">
                                            <h5 class="fw-medium mb-3">Key Responsibilities :</h5>
                                            <ol class="list-unstyled list-group-numbered mb-0">
                                                <li class="list-group-item">Write clean, scalable, and efficient code for a variety of projects.</li>
                                                <li class="list-group-item">Design and develop software solutions, applications, and systems from scratch.</li>
                                                <li class="list-group-item">Work closely with designers, product managers, and other developers to build user-friendly, high-performance web applications.</li>
                                                <li class="list-group-item">Participate in code reviews, testing, and debugging processes.</li>
                                                <li class="list-group-item">Contribute to the design and architecture of new software features.</li>
                                                <li class="list-group-item">Collaborate with the DevOps team to ensure the proper deployment and scalability of applications.</li>
                                                <li class="list-group-item">Ensure that applications are optimized for maximum speed and scalability.</li>
                                                <li class="list-group-item">Stay up-to-date with the latest software development trends, tools, and technologies.</li>
                                                <li class="list-group-item">Participate in the full software development lifecycle (SDLC), from planning through deployment.</li>
                                            </ol>
                                        </div>
                                        <div class="col-xl-6">
                                            <h5 class="fw-medium mb-3">Skills & Qualifications :</h5>
                                            <ol class="list-unstyled list-group-numbered mb-0">
                                                <li class="list-group-item">Bachelor’s degree in Computer Science, Information Technology, or related field (or equivalent experience).</li>
                                                <li class="list-group-item">Proven experience as a Software Developer or similar role.</li>
                                                <li class="list-group-item">Strong knowledge of programming languages such as JavaScript, Python, Ruby, or Java.</li>
                                                <li class="list-group-item">Familiarity with frameworks like React, Node.js, Angular, or Vue.js.</li>
                                                <li class="list-group-item">Experience with databases (SQL, NoSQL, MongoDB).</li>
                                                <li class="list-group-item">Experience with version control systems like Git.</li>
                                                <li class="list-group-item">Ability to work collaboratively in a team environment and communicate technical concepts to non-technical stakeholders.</li>
                                                <li class="list-group-item">Strong problem-solving skills and attention to detail.</li>
                                                <li class="list-group-item">Knowledge of Agile methodologies and practices.</li>
                                            </ol>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card custom-card border bg-primary-transparent shadow-none">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <h5 class="fw-medium mb-0 me-sm-0 me-2">&#128400; Was this job fit for someone?</h5>
                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center gap-4 flex-wrap">
                                                <div class="w-sm-50">
                                                    <h5 class="fw-medium mb-0">Latest Job Alerts</h5>
                                                </div>
                            ...
                            <div class="card custom-card overflow-hidden">
                                ...
                                <div class="card-body p-0">
                                    <ul class="list-group list-group-flush list-group-numbered">
                                        ...
                                        <li class="list-group-item">Comprehensive health benefits (Medical, Dental, Vision).</li>
                                        <li class="list-group-item">Generous paid time off (PTO) and paid holidays.</li>
                                        <li class="list-group-item">401(k) plan with company match.</li>
                                        <li class="list-group-item">Professional development opportunities and training programs.</li>
                                        <li class="list-group-item">Flexible work hours and the option for remote work.</li>
                                        <li class="list-group-item">Collaborative and inclusive work culture.</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="card custom-card overflow-hidden">
                                        ...
                                        <li class="list-group-item mb-2">
                                            <div class="d-sm-flex flex-wrap gap-2">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <p class="mb-0 me-3"><i class="bi bi-building text-muted"></i>  Spruko Technologies LIMITED</p>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="list-group-item mb-2">
...
<?php ob_start(); ?>
        ...
        <!-- Swiper jobs JS -->
        <script src="<?php echo $baseUrl; ?>/assets/js/job-details.js"></script>

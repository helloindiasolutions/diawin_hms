                    ...
                    <div class="row">
                        <div class="col-xxl-5">
                            <div class="card custom-card overlay-card blog-card">
                                ...
                                <img src="<?php echo $baseUrl; ?>/assets/images/media/blog/1.jpg" class="card-img" alt="...">
                                    ...
                                    <div class="card custom-card border-0 blog-card shadow-none">
                                        <div class="card-body p-0">
                                            ...
                                            <div class="blog-image mb-3">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/media/blog/2.jpg" class="card-img" alt="...">
                                            </div>
                                ...
                                <div class="col-xl-6">
                                    <div class="card custom-card border-0 blog-card shadow-none">
                                        <div class="card-body p-0">
                                            <a href="blog-details.php" class="stretched-link"></a>
                                            <div class="blog-image mb-3">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/media/blog/3.jpg" class="card-img" alt="...">
                                            </div>
                                ...
                                <div class="col-xl-6">
                                    <div class="card custom-card border-0 blog-card shadow-none">
                                        <div class="card-body p-0">
                                            <a href="blog-details.php" class="stretched-link"></a>
                                            <div class="blog-image mb-3">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/media/blog/4.jpg" class="card-img" alt="...">
                                            </div>
                                ...
                                <div class="col-xl-6">
                                    <div class="card custom-card border-0 blog-card shadow-none">
                                        <div class="card-body p-0">
                                            <a href="blog-details.php" class="stretched-link"></a>
                                            <div class="blog-image mb-3">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/media/blog/5.jpg" class="card-img" alt="...">
                                            </div>
                                    ...
                                    <ul class="list-unstyled blog-top-stories-list">
                                            ...
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-xl">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/blog/6.jpg" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                        ...
                                        <li>
                                            ...
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-xl">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/blog/7.jpg" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                        ...
                                        <li>
                                            ...
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-xl">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/blog/8.jpg" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                        ...
                                        <li>
                                            ...
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-xl">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/blog/9.jpg" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                        ...
                                        <li>
                                            ...
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-xl">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/blog/10.jpg" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="popular-cards align-items-center d-flex gap-3 flex-wrap justify-content-between">
                            <div class="">
                                <a href="javascript:void(0);">
                                    <div class="card custom-card overlay-card blog-card text-fixed-white">
                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/blog/11.jpg" class="card-img" alt="...">
                                        <div class="card-img-overlay d-flex flex-column p-0 over-content-bottom">
                            ...
                            <div class="">
                                <a href="javascript:void(0);">
                                    <div class="card custom-card overlay-card blog-card text-fixed-white">
                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/blog/12.jpg" class="card-img" alt="...">
                                        <div class="card-img-overlay d-flex flex-column p-0 over-content-bottom">
                                            <div class="card-footer border-top-0 text-center">
                            ...
                            <div class="">
                                <a href="javascript:void(0);">
                                    <div class="card custom-card overlay-card blog-card text-fixed-white">
                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/blog/13.jpg" class="card-img" alt="...">
                                        <div class="card-img-overlay d-flex flex-column p-0 over-content-bottom">
                                            <div class="card-footer border-top-0 text-center">
                            ...
                            <div class="">
                                <a href="javascript:void(0);">
                                    <div class="card custom-card overlay-card blog-card text-fixed-white">
                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/blog/14.jpg" class="card-img" alt="...">
                                        <div class="card-img-overlay d-flex flex-column p-0 over-content-bottom">
                                            <div class="card-footer border-top-0 text-center">
                            ...
                            <div class="">
                                <a href="javascript:void(0);">
                                    <div class="card custom-card overlay-card blog-card text-fixed-white">
                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/blog/15.jpg" class="card-img" alt="...">
                                        <div class="card-img-overlay d-flex flex-column p-0 over-content-bottom">
                                            <div class="card-footer border-top-0 text-center">
                            ...
                            <div class="">
                                <a href="javascript:void(0);">
                                    <div class="card custom-card overlay-card blog-card text-fixed-white">
                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/blog/16.jpg" class="card-img" alt="...">
                                        <div class="card-img-overlay d-flex flex-column p-0 over-content-bottom">
                                            <div class="card-footer border-top-0 text-center">
                            ...
                            <div class="">
                                <a href="javascript:void(0);">
                                    <div class="card custom-card overlay-card blog-card text-fixed-white">
                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/blog/17.jpg" class="card-img" alt="...">
                                        <div class="card-img-overlay d-flex flex-column p-0 over-content-bottom">
                                            <div class="card-footer border-top-0 text-center">
                            ...
                            <div class="">
                                <a href="javascript:void(0);">
                                    <div class="card custom-card overlay-card blog-card text-fixed-white">
                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/blog/18.jpg" class="card-img" alt="...">
                                        <div class="card-img-overlay d-flex flex-column p-0 over-content-bottom">
                                            <div class="card-footer border-top-0 text-center">
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6">
                                    <div class="card custom-card border-0 blog-card shadow-none">
                                        <div class="card-body p-0">
                                            <a href="blog-details.php" class="stretched-link"></a>
                                            <div class="blog-image mb-3">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/media/blog/19.jpg" class="card-img" alt="...">
                                            </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6">
                                    <div class="card custom-card border-0 blog-card shadow-none">
                                        <div class="card-body p-0">
                                            <a href="blog-details.php" class="stretched-link"></a>
                                            <div class="blog-image mb-3">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/media/blog/20.jpg" class="card-img" alt="...">
                                            </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6">
                                    <div class="card custom-card border-0 blog-card shadow-none">
                                        <div class="card-body p-0">
                                            <a href="blog-details.php" class="stretched-link"></a>
                                            <div class="blog-image mb-3">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/media/blog/21.jpg" class="card-img" alt="...">
                                            </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6">
                                    <div class="card custom-card border-0 blog-card shadow-none">
                                        <div class="card-body p-0">
                                            <a href="blog-details.php" class="stretched-link"></a>
                                            <div class="blog-image mb-3">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/media/blog/22.jpg" class="card-img" alt="...">
                                            </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6">
                                    <div class="card custom-card border-0 blog-card shadow-none">
                                        <div class="card-body p-0">
                                            <a href="blog-details.php" class="stretched-link"></a>
                                            <div class="blog-image mb-3">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/media/blog/23.jpg" class="card-img" alt="...">
                                            </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6">
                                    <div class="card custom-card border-0 blog-card shadow-none">
                                        <div class="card-body p-0">
                                            <a href="blog-details.php" class="stretched-link"></a>
                                            <div class="blog-image mb-3">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/media/blog/24.jpg" class="card-img" alt="...">
                                            </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6">
                                    <div class="card custom-card border-0 blog-card shadow-none">
                                        <div class="card-body p-0">
                                            <a href="blog-details.php" class="stretched-link"></a>
                                            <div class="blog-image mb-3">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/media/blog/25.jpg" class="card-img" alt="...">
                                            </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6">
                                    <div class="card custom-card border-0 blog-card shadow-none">
                                        <div class="card-body p-0">
                                            <a href="blog-details.php" class="stretched-link"></a>
                                            <div class="blog-image mb-3">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/media/blog/26.jpg" class="card-img" alt="...">
                                            </div>
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item">
                                            ...
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-xl">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/blog/11.jpg" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-xl">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/blog/4.jpg" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">

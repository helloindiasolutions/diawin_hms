...
<?php ob_start(); ?>
                    ...
                    <div class="page-header-breadcrumb mb-3">
                        <div class="d-flex align-center justify-content-between flex-wrap">
                            <h1 class="page-title fw-medium fs-18 mb-0">Navs & Tabs</h1>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <ul class="nav nav-tabs border-0 gap-sm-0 gap-2">
                                        <li class="nav-item">
                        ...
                        <div class="col-xl-12">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <ul class="nav nav-pills gap-sm-0 gap-2">
                                        <li class="nav-item">
                                            <a class="nav-link active" aria-current="page" href="javascript:void(0);">Active</a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <ul class="nav nav-tabs mb-3 tab-style-8 scaleX" id="myTab4" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active" id="home-style8-tab" data-bs-toggle="tab"
                                                ...
                                                aria-controls="home-style8-tab-pane" aria-selected="true">Home</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="about-style8-tab" data-bs-toggle="tab"
                                                data-bs-target="#about-style8-tab-pane" type="button" role="tab"
                                                aria-controls="about-style8-tab-pane" aria-selected="false">About</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="services-style8-tab" data-bs-toggle="tab"
                                                ...
                                                aria-controls="services-style8-tab-pane" aria-selected="false">Services</button>
                                        </li>
                                    </ul>
                                    <div class="tab-content" id="myTabContent3">
                                        <div class="tab-pane show active overflow-hidden" id="home-style8-tab-pane"
                                            role="tabpanel" aria-labelledby="home-style8-tab" tabindex="0">
                                            when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
                                        </div>
                                        <div class="tab-pane overflow-hidden" id="about-style8-tab-pane" role="tabpanel"
                                        ...
                                        <div class="tab-pane overflow-hidden" id="services-style8-tab-pane" role="tabpanel"

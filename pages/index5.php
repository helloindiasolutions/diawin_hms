                            ...
                            <div class="row">
                                    ...
                                    <div class="card custom-card nft-main-banner-card border-0">
                                        <div class="card-body">
                                            <div class="nft-main-bannr-background">
                                                <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/1.png" alt="" class="d-md-block d-none">
                                            </div>
                                ...
                                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body p-2">
                                            <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/2.png" class="card-img mb-3" alt="...">
                                            <div class="p-2">
                                                <div class="mb-3">
                                                    <a href="nft-details.php"><h6 class="fw-semibold mb-1 text-truncate">Neon Samurai: Blade of the Future</h6></a>
                                                        ...
                                                        <div class="d-flex align-items-center gap-2 fw-semibold">
                                                            <div class="lh-1">
                                                                <span class="avatar avatar-xs avatar-rounded">
                                                                    <img src="<?php echo $baseUrl; ?>/assets/images/crypto-currencies/crypto-icons/ethereum-eth-logo.svg" alt="">
                                                                </span>
                                                            </div>
                                                            <div>
                                                                12.45ETH
                                ...
                                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body p-2">
                                            <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/3.png" class="card-img mb-3" alt="...">
                                            <div class="p-2">
                                                <div class="mb-3">
                                                    <a href="nft-details.php"><h6 class="fw-semibold mb-1 text-truncate">Cybercity Uprising: Rebels of the Neon Streets</h6></a>
                                ...
                                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body p-2">
                                            <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/4.png" class="card-img mb-3" alt="...">
                                            <div class="p-2">
                                                <div class="mb-3">
                                                    <a href="nft-details.php"><h6 class="fw-semibold mb-1 text-truncate">Holo-Vision: The Last Cyberpunk Hero</h6></a>
                                            ...
                                            <ul class="list-unstyled nft-top-collectors-list">
                                                    ...
                                                    <div class="d-flex align-items-center gap-2 flex-wrap">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-md avatar-rounded">
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/6.jpg" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="flex-fill">
                                                ...
                                                <li>
                                                    <div class="d-flex align-items-center gap-2 flex-wrap">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-md avatar-rounded">
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/15.jpg" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="flex-fill">
                                                ...
                                                <li>
                                                    <div class="d-flex align-items-center gap-2 flex-wrap">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-md avatar-rounded">
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/16.jpg" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="flex-fill">
                                                            <span class="fw-semibold d-block">Kairo Tetsuo<i class="bi bi-patch-check-fill text-primary align-middle ms-2"></i></span>
                                                ...
                                                <li>
                                                    <div class="d-flex align-items-center gap-2 flex-wrap">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-md avatar-rounded">
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/17.jpg" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="flex-fill">
                                                ...
                                                <li>
                                                    <div class="d-flex align-items-center gap-2 flex-wrap">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-md avatar-rounded">
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/11.jpg" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="flex-fill">
                                                ...
                                                <li>
                                                    <div class="d-flex align-items-center gap-2 flex-wrap">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-md avatar-rounded">
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/9.jpg" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="flex-fill">
                                                ...
                                                <li>
                                                    <div class="d-flex align-items-center gap-2 flex-wrap">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-md avatar-rounded">
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/8.jpg" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="flex-fill">
                                    ...
                                    <ul class="list-unstyled nft-top-drops-list">
                                        <li>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-md avatar-rounded">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/36.png" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                        ...
                                        <li>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-md avatar-rounded">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/38.png" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                        ...
                                        <li>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-md avatar-rounded">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/40.png" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                        ...
                                        <li>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-md avatar-rounded">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/41.png" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                        ...
                                        <li>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-md avatar-rounded">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/42.png" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                        ...
                                        <li>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-md avatar-rounded">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/43.png" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="card custom-card border-0 shadow-none mb-0">
                                                    <div class="card-body p-0">
                                                        <div class="row g-2">
                                                            <div class="col-12">
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/38.png" alt="" class="nft-featuredcollect-image rounded">
                                                            </div>
                                                            <div class="col-6">
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/40.png" alt="" class="nft-featuredcollect-image rounded">
                                                            </div>
                                                            <div class="col-6">
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/41.png" alt="" class="nft-featuredcollect-image rounded">
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="card custom-card border-0 shadow-none mb-0">
                                                    <div class="card-body p-0">
                                                        <div class="row g-2">
                                                            <div class="col-12">
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/35.png" alt="" class="nft-featuredcollect-image rounded">
                                                            </div>
                                                            <div class="col-6">
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/36.png" alt="" class="nft-featuredcollect-image rounded">
                                                            </div>
                                                            <div class="col-6">
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/37.png" alt="" class="nft-featuredcollect-image rounded">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="card-footer border-top-0 pb-0">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="card custom-card border-0 shadow-none mb-0">
                                                    <div class="card-body p-0">
                                                        <div class="row g-2">
                                                            <div class="col-12">
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/39.png" alt="" class="nft-featuredcollect-image rounded">
                                                            </div>
                                                            <div class="col-6">
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/42.png" alt="" class="nft-featuredcollect-image rounded">
                                                            </div>
                                                            <div class="col-6">
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/43.png" alt="" class="nft-featuredcollect-image rounded">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="card-footer border-top-0 pb-0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="lh-1">
                                                                <span class="avatar avatar-md avatar-rounded">
                                                                    <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/35.png" alt="">
                                                                </span>
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="lh-1">
                                                                <span class="avatar avatar-md avatar-rounded">
                                                                    <img src="<?php echo $baseUrl; ?>/assets/images/nft-images/37.png" alt="">
                                                                </span>
                                                            </div>
                                                            <div>

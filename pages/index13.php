                                            ...
                                            <div class="card custom-card podcast-banner-card border-0 shadow-none">
                                                <div class="card-body">
                                                    <div class="podcast-banner-card-background">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/backgrounds/6.png" alt="">
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-xl-8">
                                                        ...
                                                        <div class="col-xl-4">
                                                            <img src="<?php echo $baseUrl; ?>/assets/images/media/media-70.png" alt="" class="podcast-banner-img img-fluid d-md-block d-none">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="card custom-card">
                                                <div class="row g-0">
                                                    <div class="col-3">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/media-71.jpg" class="img-fluid rounded-start h-100 w-100" alt="...">
                                                    </div>
                                                    <div class="col-9">
                                        ...
                                        <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="card custom-card">
                                                <div class="row g-0">
                                                    <div class="col-3">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/media-73.jpg" class="img-fluid rounded-start h-100 w-100" alt="...">
                                                    </div>
                                                    <div class="col-9">
                                                        <div class="card-body p-4">
                                                            <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="card custom-card">
                                                <div class="row g-0">
                                                    <div class="col-3">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/media-79.jpg" class="img-fluid rounded-start h-100 w-100" alt="...">
                                                    </div>
                                                    <div class="col-9">
                                                        <div class="card-body p-4">
                                                            <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="card custom-card">
                                                <div class="row g-0">
                                                    <div class="col-3">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/media-77.jpg" class="img-fluid rounded-start h-100 w-100" alt="...">
                                                    </div>
                                                    <div class="col-9">
                                                        <div class="card-body p-4">
                                                            <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="card custom-card">
                                                <div class="row g-0">
                                                    <div class="col-3">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/media-76.jpg" class="img-fluid rounded-start h-100 w-100" alt="...">
                                                    </div>
                                                    <div class="col-9">
                                                        <div class="card-body p-4">
                                                            <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="card custom-card">
                                                <div class="row g-0">
                                                    <div class="col-3">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/media-75.jpg" class="img-fluid rounded-start h-100 w-100" alt="...">
                                                    </div>
                                                    <div class="col-9">
                                                        <div class="card-body p-4">
                                                            <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="card-body p-4">
                                            <div class="text-center mb-4">
                                                <span class="avatar mb-3 podcast-playing-now-avatar shadow">
                                                    <img src="<?php echo $baseUrl; ?>/assets/images/media/media-78.jpg" alt="">
                                                </span>
                                            ...
                                            <ul class="list-group list-group-flush">
                                                    ...
                                                    <div class="d-flex align-items-center gap-2 flex-wrap">
                                                        ...
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-md avatar-rounded">
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/media/media-73.jpg" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="flex-fill">
                                                ...
                                                <li class="list-group-item">
                                                    <div class="d-flex align-items-center gap-2 flex-wrap">
                                                        ...
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-md avatar-rounded">
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/media/media-79.jpg" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="flex-fill">
                                                ...
                                                <li class="list-group-item">
                                                    <div class="d-flex align-items-center gap-2 flex-wrap">
                                                        ...
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-md avatar-rounded">
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/media/media-77.jpg" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="flex-fill">
                                                ...
                                                <li class="list-group-item">
                                                    <div class="d-flex align-items-center gap-2 flex-wrap">
                                                        ...
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-md avatar-rounded">
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/media/media-76.jpg" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="flex-fill">
                                                ...
                                                <li class="list-group-item">
                                                    <div class="d-flex align-items-center gap-2 flex-wrap">
                                                        ...
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-md avatar-rounded">
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/media/media-71.jpg" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="flex-fill">

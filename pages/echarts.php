...
<?php ob_start(); ?>
                    ...
                    <div class="page-header-breadcrumb mb-3">
                        <div class="d-flex align-center justify-content-between flex-wrap">
                            <h1 class="page-title fw-medium fs-18 mb-0">Echart Charts</h1>
...
<?php ob_start(); ?>
        ...
        <!-- Echarts JS -->
        <script src="<?php echo $baseUrl; ?>/assets/libs/echarts/echarts.min.js"></script>

        <!-- Internal Echarts JS -->
        <script src="<?php echo $baseUrl; ?>/assets/js/echarts.js"></script>

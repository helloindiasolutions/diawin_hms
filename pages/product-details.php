                                        ...
                                        <div class="row g-5">
                                                ...
                                                <div class="swiper swiper-preview-details bg-light product-details-page">
                                                    <div class="swiper-wrapper">
                                                        <div class="swiper-slide" id="img-container">
                                                            <img class="img-fluid" src="<?php echo $baseUrl; ?>/assets/images/ecommerce/jpg/4.jpg" alt="img">
                                                        </div>
                                                        <div class="swiper-slide image-container">
                                                            <img class="img-fluid" src="<?php echo $baseUrl; ?>/assets/images/ecommerce/jpg/2.jpg" alt="img">
                                                        </div>
                                                        <div class="swiper-slide image-container">
                                                            <img class="img-fluid" src="<?php echo $baseUrl; ?>/assets/images/ecommerce/jpg/3.jpg" alt="img">
                                                        </div>
                                                        <div class="swiper-slide image-container">
                                                            <img class="img-fluid" src="<?php echo $baseUrl; ?>/assets/images/ecommerce/jpg/1.jpg" alt="img">
                                                        </div>
                                                        <div class="swiper-slide image-container">
                                                            <img class="img-fluid" src="<?php echo $baseUrl; ?>/assets/images/ecommerce/jpg/5.jpg" alt="img">
                                                        </div>
                                                        <div class="swiper-slide image-container">
                                                            <img class="img-fluid" src="<?php echo $baseUrl; ?>/assets/images/ecommerce/jpg/6.jpg" alt="img">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <div class="d-flex align-items-center justify-content-center gap-2 mt-5 flex-wrap">
                                                    <a href="cart.php" class="btn btn-light btn-lg btn-w-lg disabled border"><i class="ti ti-shopping-cart me-1"></i>Add To Cart</a>
                                                    <a href="checkout.php" class="btn btn-light btn-lg btn-w-lg disabled border">Buy Now</a>
                                                </div>
                                            </div>

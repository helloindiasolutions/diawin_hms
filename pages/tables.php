...
<?php ob_start(); ?>
                    ...
                    <div class="page-header-breadcrumb mb-3">
                        <div class="d-flex align-center justify-content-between flex-wrap">
                            <h1 class="page-title fw-medium fs-18 mb-0">Tables</h1>
    ...
    <!-- Prism Code -->
                        ...
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table text-nowrap table-bordered custom-table-bordered">
                                            <thead>
                                                <tr>
                    ...
                    <div class="row">
                        <div class="col-xl-4">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table text-nowrap table-bordered border-primary me-1">
                                            <thead>
                                                <tr>
    ...
    <!-- Prism Code -->
                        ...
                        <div class="col-xl-4">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table text-nowrap table-bordered border-success me-1">
                                            <thead>
                                                <tr>
                                                    <th scope="col">Order</th>
                                                    <th scope="col">Date</th>
    ...
    <!-- Prism Code -->
                        ...
                        <div class="col-xl-4">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table text-nowrap table-bordered border-warning me-1">
                                            <thead>
                                                <tr>
                                                    <th scope="col">Order</th>
                                                    <th scope="col">Date</th>

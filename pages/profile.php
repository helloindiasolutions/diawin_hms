                                                ...
                                                <div class="col-xxl-8">
                                                    ...
                                                    <div class="card custom-card">
                                                        <div class="card-body">
                                                            ...
                                                            <div>
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/media/media-23.jpg" class="card-img" alt="...">
                                                            </div>
                                                        </div>
                                                                    ...
                                                                    <div class="d-flex align-items-center lh-1 flex-wrap"> 
                                                                        ...
                                                                        <div class="flex-fill"> 
                                                                            <div class="input-group"> 
                                                                                ...
                                                                                <button class="btn btn-light border px-2 px-xl-3" type="button"><i class="bi bi-emoji-smile"></i></button> 
                                                                                <button class="btn btn-light border px-2 px-xl-3" type="button"><i class="bi bi-paperclip"></i></button> 
                                                                                <button class="btn btn-light border px-2 px-xl-3" type="button"><i class="bi bi-camera"></i></button> 
                                                    ...
                                                    <div class="card custom-card">
                                                        <div class="card-body">
                                                            ...
                                                            <div>
                                                                <img src="<?php echo $baseUrl; ?>/assets/images/media/media-10.jpg" class="card-img" alt="...">
                                                            </div>
                                                        </div>
                                                        <div class="card-footer">
                                                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                                    ...
                                                    <div class="card custom-card">
                                                        <div class="card-body">
                                                            <div class="row gy-4">
                                                                ...
                                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                                                    <a href="<?php echo $baseUrl; ?>/assets/images/media/media-26.jpg" class="glightbox" data-gallery="gallery1">
                                                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/media-26.jpg" alt="image" class="img-fluid rounded">
                                                                    </a>
                                                                </div>
                                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                                                    <a href="<?php echo $baseUrl; ?>/assets/images/media/media-32.jpg" class="glightbox" data-gallery="gallery1">
                                                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/media-32.jpg" alt="image" class="img-fluid rounded">
                                                                    </a>
                                                                </div>
                                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                                                    <a href="<?php echo $baseUrl; ?>/assets/images/media/media-30.jpg" class="glightbox" data-gallery="gallery1">
                                                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/media-30.jpg" alt="image" class="img-fluid rounded">
                                                                    </a>
                                                                </div>
                                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                                                    <a href="<?php echo $baseUrl; ?>/assets/images/media/media-31.jpg" class="glightbox" data-gallery="gallery1">
                                                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/media-31.jpg" alt="image" class="img-fluid rounded">
                                                                    </a>
                                                                </div>
                                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                                                    <a href="<?php echo $baseUrl; ?>/assets/images/media/media-46.jpg" class="glightbox" data-gallery="gallery1">
                                                                ...
                                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                                                    <a href="<?php echo $baseUrl; ?>/assets/images/media/media-59.jpg" class="glightbox" data-gallery="gallery1">
                                                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/media-59.jpg" alt="image" class="img-fluid rounded">
                                                                    </a>
                                                                </div>
                                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                                                    <a href="<?php echo $baseUrl; ?>/assets/images/media/media-61.jpg" class="glightbox" data-gallery="gallery1">

                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="input-group mb-3">
                                                <button class="btn btn-primary" type="button">Button</button>
                                                <button class="btn btn-primary" type="button">Button</button>
                                                <input type="text" class="form-control px-sm-3 px-1" placeholder=""
                                                    aria-label="Example text with two button addons">
                                            </div>
                                            <div class="input-group">
                                                <input type="text" class="form-control px-sm-3 px-1" placeholder="Recipient's username"
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="input-group flex-nowrap">
                                                <button class="btn btn-primary-transparent dropdown-toggle px-2 px-sm-3" type="button"
                                                    data-bs-toggle="dropdown" aria-expanded="false">Dropdown</button>
                                                <ul class="dropdown-menu">
                                                ...
                                                <button class="btn btn-primary-transparent dropdown-toggle px-1 px-sm-3" type="button"
                                                    data-bs-toggle="dropdown" aria-expanded="false">Dropdown</button>
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li><a class="dropdown-item" href="javascript:void(0);">Action</a></li>
                                                    <li><a class="dropdown-item" href="javascript:void(0);">Another action</a></li>
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="file" class="form-control py-1" id="inputGroupFile03"
                                                    aria-describedby="inputGroupFileAddon03" aria-label="Upload">
                                            </div>

                                            <div class="input-group">
                                                <input type="file" class="form-control py-1" id="inputGroupFile04"

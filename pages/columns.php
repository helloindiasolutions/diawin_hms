...
<?php ob_start(); ?>
                    ...
                    <div class="page-header-breadcrumb mb-3">
                        <div class="d-flex align-center justify-content-between flex-wrap">
                            <h1 class="page-title fw-medium fs-18 mb-0">Columns</h1>
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body bd-example-row">
                                            <p class="mb-4">With the move to flexbox in v4, you can use margin utilities like
                                                <span class="text-danger me-2">.me-auto</span>to force sibling columns
                                                away
                                                from one
                                                another.
                                            </p>
                            ...
                            <div class="card custom-card">
                                <div class="card-body">
                                    <P>The classes can be used together with utilities to create responsive floated
                                        ...
                                        is shorter.</P>
                                    <div class="clearfix">
                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/media-40.jpg" class="bd-placeholder-img col-md-6 float-md-end mb-3 ms-md-3 rounded img-fluid" alt="...">
                                        <p>

...
<?php ob_start(); ?>
                    ...
                    <div class="page-header-breadcrumb mb-3">
                        <div class="d-flex align-center justify-content-between flex-wrap">
                            <h1 class="page-title fw-medium fs-18 mb-0">Css Grid</h1>
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body bd-example-cssgrid text-center overflow-x-auto">
                                            <P>Change the vertical gaps only by modifying the <span
                                                ...
                                                <span class="text-danger me-1">.grid</span>s, but row-gap and <Span
                                                    class="text-danger me-1">column-gap</Span>can be modified as needed.
                                            </P>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body bd-example-cssgrid text-center nesting-grid-reponsive overflow-x-auto">

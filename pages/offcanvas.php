                                              ...
                                              <ul class="list-group list-group-flush mb-0">
                                                  <li class="list-group-item">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-fill">
                                                            <p class="fw-medium mb-0">New Website Created<span class="badge bg-light text-muted float-end">20 Nov 2024</span></p>
                                                  ...
                                                  <li class="list-group-item">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-fill">
                                                            <p class="fw-medium mb-0">Meeting at 3:00 pm<span class="badge bg-light text-muted float-end">29 Dec 2024</span></p>
                                                  ...
                                                  <li class="list-group-item">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-fill">
                                                            <p class="fw-medium mb-0">Prepare for presentation<span class="badge bg-light text-muted float-end">31 Dec 2024</span></p>
                                                            <span class="fs-12 text-muted"><i class="ri-time-line align-middle me-1 d-inline-block"></i>4 hrs ago</span>
                                                        </div>
                                                    </div>
                                                  </li>

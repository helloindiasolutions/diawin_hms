                        ...
                        <div class="col-xxl-3">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-grid">
                                        <button class="btn btn-light btn-lg">View Complete Statistics <i class="ti ti-arrow-narrow-right ms-1"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <ul class="list-unstyled hrm-employee-list">
                                        <li>
                                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                                ...
                                                <div class="flex-fill">
                                                    <span class="d-block fw-semibold">Sarah Miller<span class="badge bg-primary-transparent ms-2">Marketing</span></span>
                                        ...
                                        <li>
                                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                                ...
                                                <div class="flex-fill">
                                                    <span class="d-block fw-semibold">Mark Taylor<span class="badge bg-warning-transparent ms-2">IT & Development</span></span>
                                                    <span class="text-muted fs-13">
                                                        Backend Developer
                                                    </span>
                                                </div>
                                        ...
                                        <li>
                                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                                ...
                                                <div class="flex-fill">
                                                    <span class="d-block fw-semibold">Jessica Lee<span class="badge bg-secondary-transparent ms-2">Operations</span></span>
                                                    <span class="text-muted fs-13">
                                                        Project Manager
                                                    </span>
                                                </div>
                                        ...
                                        <li>
                                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                                ...
                                                <div class="flex-fill">
                                                    <span class="d-block fw-semibold">David Wilson<span class="badge bg-info-transparent ms-2">IT & Development</span></span>
                                                    <span class="text-muted fs-13">
                                                        Data Scientist
                                                    </span>
                                                </div>
                                        ...
                                        <li>
                                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                                ...
                                                <div class="flex-fill">
                                                    <span class="d-block fw-semibold">Lisa Grant<span class="badge bg-success-transparent ms-2">Finance</span></span>
                                                    <span class="text-muted fs-13">
                                                        Finance Analyst
                                                    </span>
                                                </div>
                                        ...
                                        <li>
                                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                                ...
                                                <div class="flex-fill">
                                                    <span class="d-block fw-semibold">John Peterson<span class="badge bg-success-transparent ms-2">Sales</span></span>
                                                    <span class="text-muted fs-13">
                                                        Sales Executive
                                                    </span>
                                                </div>
                        ...
                        <div class="col-xxl-4">
                            <div class="card custom-card overflow-hidden">
                                <div class="card-header justify-content-between">
                                    ...
                                    <div class="dropdown"> 
                                        <a href="javascript:void(0);" class="fs-12 text-muted" data-bs-toggle="dropdown" aria-expanded="false"> Sort By <i class="ri-arrow-down-s-line align-middle ms-1 d-inline-block"></i> 
                                        </a> 
                                        ...
                                        <table class="table text-nowrap table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge bg-primary-transparent rounded-pill min-w-badge">Fullday</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <span class="badge bg-danger-transparent rounded-pill min-w-badge">LateArrived</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge bg-warning-transparent rounded-pill min-w-badge">Early Depature</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table text-nowrap">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th scope="row"><input class="form-check-input" type="checkbox" id="checkboxNoLabel13" value="" aria-label="..." checked=""></th>
                                                    <td>
                                                        #SPT-012
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <th scope="row"><input class="form-check-input" type="checkbox" id="checkboxNoLabel4" value="" aria-label="..."></th>
                                                    <td>
                                                        #SPT-013
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <th scope="row"><input class="form-check-input" type="checkbox" id="checkboxNoLabel5" value="" aria-label="..." checked=""></th>
                                                    <td>
                                                        #SPT-014
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <th scope="row"><input class="form-check-input" type="checkbox" id="checkboxNoLabel3" value="" aria-label="..." checked=""></th>
                                                    <td>
                                                        #SPT-015
                                                    </td>
                                                    <td>
...
<?php ob_start(); ?>
        ...
        <!-- HRM Dashboard --> 
        <script src="<?php echo $baseUrl; ?>/assets/js/hrm-dashboard.js"></script>

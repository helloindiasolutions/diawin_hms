...
<!-- Toastify CSS -->
<link rel="stylesheet" href="<?php echo $baseUrl; ?>/assets/libs/toastify-js/src/toastify.css">
...
<div class="page-header-breadcrumb mb-3">
    <div class="d-flex align-center justify-content-between flex-wrap">
        <h1 class="page-title fw-medium fs-18 mb-0">Toast</h1>
                    ...
                    <div id="liveToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
                        <div class="toast-header text-default">
                            <img class="bd-placeholder-img rounded me-2"
                                src="<?php echo $baseUrl; ?>/assets/images/brand-logos/favicon_io/favicon.ico"
                                alt="...">
...
&lt;div class="toast-container position-fixed top-0 end-0 p-3"&gt;
    &lt;div id="liveToast" class="toast" role="alert" aria-live="assertive"
        aria-atomic="true"&gt;
        &lt;div class="toast-header text-default"&gt;
            &lt;img class="bd-placeholder-img rounded me-2" src="<?php echo $baseUrl; ?>/assets/images/brand-logos/favicon_io/favicon.ico" alt="..."&gt;
            &lt;strong class="me-auto"&gt;Vyzor&lt;/strong&gt;
            &lt;small&gt;11 mins ago&lt;/small&gt;
...
&lt;/div&gt;</code></pre>
        ...
        <div class="card custom-card">
            ...
            <div class="card-body">
                ...
                <div class="toast align-items-center text-bg-warning border-0 fade show mb-4" role="alert"
                    aria-live="assertive" aria-atomic="true">
                    <div class="d-flex">
                        <div class="toast-body">
        ...
        <div class="card custom-card">
            ...
            <div class="card-body">
                <div class="toast fade show" role="alert" aria-live="assertive" aria-atomic="true">
                    <div class="toast-header text-default">
                        <img class="bd-placeholder-img rounded me-2"
                            src="<?php echo $baseUrl; ?>/assets/images/brand-logos/favicon_io/favicon.ico" alt="...">
                ...
                <div class="toast-container position-fixed top-0 end-0 p-3">
                    <div id="primaryToast" class="toast colored-toast bg-primary-transparent" role="alert"
                        ...
                        <div class="toast-header bg-primary">
                            <img class="bd-placeholder-img rounded me-2"
                                src="<?php echo $baseUrl; ?>/assets/images/brand-logos/toggle-dark.png" alt="...">
                            <strong class="me-auto text-fixed-white">Vyzor</strong>
                            <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button>
                        </div>
                        <div class="toast-body">
...
&lt;div class="toast-container position-fixed top-0 end-0 p-3"&gt;
    &lt;div id="primaryToast" class="toast colored-toast bg-primary-transparent" role="alert" aria-live="assertive"
        aria-atomic="true"&gt;
        &lt;div class="toast-header bg-primary"&gt;
            &lt;img class="bd-placeholder-img rounded me-2" src="<?php echo $baseUrl; ?>/assets/images/brand-logos/toggle-dark.png" alt="..."&gt;
            &lt;strong class="me-auto"&gt;Vyzor&lt;/strong&gt;
            &lt;button type="button" class="btn-close" data-bs-dismiss="toast"
                aria-label="Close"&gt;&lt;/button&gt;
        &lt;/div&gt;
    ...
    <div class="col-xl-12">
        <div class="card custom-card">
            ...
            <div class="card-body">
                ...
                <div class="toast-container position-fixed top-0 end-0 p-3">
                    <div id="solid-primaryToast" class="toast colored-toast bg-primary" role="alert"
                        aria-live="assertive" aria-atomic="true">
                        <div class="toast-header bg-primary">
                            <img class="bd-placeholder-img rounded me-2"
                                src="<?php echo $baseUrl; ?>/assets/images/brand-logos/toggle-dark.png" alt="...">
...
&lt;/div&gt;
&lt;div class="toast-container position-fixed top-0 end-0 p-3"&gt;
    &lt;div id="solid-primaryToast" class="toast colored-toast bg-primary" role="alert" aria-live="assertive"
        aria-atomic="true"&gt;
        &lt;div class="toast-header bg-primary"&gt;
            &lt;img class="bd-placeholder-img rounded me-2" src="<?php echo $baseUrl; ?>/assets/images/brand-logos/toggle-dark.png" alt="..."&gt;
            &lt;strong class="me-auto"&gt;Vyzor&lt;/strong&gt;
...
<div class="row">
    <div class="col-xl-12">
        <div class="card custom-card">
            ...
            <div class="card-body">
                <div class="btn-list">
                    <button type="button" class="btn btn-outline-primary me-2 btn-wave" id="topleftToastBtn">Top
                        Left</button>
                    <button type="button" class="btn btn-outline-primary me-2 btn-wave" id="topcenterToastBtn">Top
                        Center</button>
                    <button type="button" class="btn btn-outline-primary me-2 btn-wave" id="toprightToastBtn">Top
                        Right</button>
                    <button type="button" class="btn btn-outline-primary me-2 btn-wave" id="middleleftToastBtn">Middle
                        Left</button>
                    ...
                    <button type="button" class="btn btn-outline-primary me-2 btn-wave" id="middlerightToastBtn">Middle
                        Right</button>
                    <button type="button" class="btn btn-outline-primary me-2 btn-wave" id="bottomleftToastBtn">Bottom
                        Left</button>
                    <button type="button" class="btn btn-outline-primary me-2 btn-wave" id="bottomcenterToastBtn">Bottom
                        Center</button>
                    <button type="button" class="btn btn-outline-primary me-2 btn-wave" id="bottomrightToastBtn">Bottom
                        Right</button>
                </div>
...
&lt;/div&gt;</code></pre>
    ...
    <div class="col-xl-6">
        <div class="card custom-card">
            ...
            <div class="card-body">
                <button class="btn btn-primary btn-wave" id="toast-button">Click For Live Toast</button>
            </div>
        </div>
    </div>
</div>
...
<!-- Toastify JS -->
<script src="<?php echo $baseUrl; ?>/assets/libs/toastify-js/src/toastify.js"></script>
...
<!-- Toast JS -->
<script src="<?php echo $baseUrl; ?>/assets/js/toasts.js"></script>

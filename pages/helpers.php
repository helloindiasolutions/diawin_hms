...
<?php ob_start(); ?>
                    ...
                    <div class="page-header-breadcrumb mb-3">
                        <div class="d-flex align-center justify-content-between flex-wrap">
                            <h1 class="page-title fw-medium fs-18 mb-0">Helpers</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-12">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <img class="bd-placeholder-img card-img-top card-img" src="<?php echo $baseUrl; ?>/assets/images/media/media-4.jpg" alt="...">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-4 col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <a href="javascript:void(0)" class="d-inline-flex focus-ring py-1 px-2 text-decoration-none border rounded-2">
                                        Custom focus ring
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-xxl-4 col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <a href="javascript:void(0)" class="d-inline-flex focus-ring py-1 px-2 text-decoration-none border rounded-2" style="--bs-focus-ring-color: rgba(var(--success-rgb), .25)">
                                        Green focus ring
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-xxl-4 col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-body p-4">
                                    <a href="javascript:void(0)" class="d-inline-flex focus-ring py-1 px-2 text-decoration-none border rounded-2" style="--bs-focus-ring-x: 10px; --bs-focus-ring-y: 10px; --bs-focus-ring-blur: 4px">
                                        Blurry offset focus ring
                                    </a>
                                </div>
                            </div>

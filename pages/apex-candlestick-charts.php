...
<?php ob_start(); ?>
        ...
        <script src="<?php echo $baseUrl; ?>/assets/js/apexcharts-candlestick-seriesdata.js"></script>

        <!-- Used For Candlestick With Category X-axis Chart-->
        <script src="<?php echo $baseUrl; ?>/assets/js/apexcharts-dayjs.min.js"></script>

        <!-- Internal Apex Candlestick Charts JS -->
        <script src="<?php echo $baseUrl; ?>/assets/js/apexcharts-candlestick.js"></script>

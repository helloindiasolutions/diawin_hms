...
<?php ob_start(); ?>
                    ...
                    <div class="page-header-breadcrumb mb-3">
                        <div class="d-flex align-center justify-content-between flex-wrap">
                            <h1 class="page-title fw-medium fs-18 mb-0">Additional Content</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <img class="bd-placeholder-img mw-100 card-img" src="<?php echo $baseUrl; ?>/assets/images/media/media-7.jpg" alt="...">
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <div class="float-start p-2 bg-primary text-fixed-white  rounded mb-2">Float start</div><br>
                                            <div class="float-end p-2 bg-primary text-fixed-white  rounded">Float end</div><br>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card custom-card mb-5 mb-xl-3">
                                <div class="card-header">
                                    <div class="card-title">
                                        Overflow
                                    </div>

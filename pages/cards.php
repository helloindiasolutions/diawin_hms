...
<?php ob_start(); ?>
                    ...
                    <div class="row">
                        <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="card custom-card">
                                <img src="<?php echo $baseUrl; ?>/assets/images/media/media-24.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                        ...
                        <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="card custom-card">
                                <img src="<?php echo $baseUrl; ?>/assets/images/media/media-22.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h6 class="card-title fw-medium">Card title</h6>
                        ...
                        <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="card custom-card">
                                <img src="<?php echo $baseUrl; ?>/assets/images/media/media-23.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <p class="card-text">Some quick example text to build on the card title and
                                        make up the bulk of the card's content.</p>
                                </div>
                        ...
                        <div class="col-xxl-6 col-xl-6 col-lg-12">
                            ...
                            <div class="row row-cols-12">
                                <div class="col">
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            <img src="<?php echo $baseUrl; ?>/assets/images/media/media-25.jpg" class="card-img mb-3" alt="...">
                                ...
                                <div class="col">
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            <img src="<?php echo $baseUrl; ?>/assets/images/media/media-26.jpg" class="card-img mb-3" alt="...">
                                ...
                                <div class="col">
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            <img src="<?php echo $baseUrl; ?>/assets/images/media/media-27.jpg" class="card-img mb-3" alt="...">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-2">
                            <div class="card custom-card">
                                <div class="card-body">
                                    <img src="<?php echo $baseUrl; ?>/assets/images/media/media-4.jpg" class="card-img mb-3" alt="...">
                        ...
                        <div class="col-xl-2">
                            <div class="card custom-card">
                                <div class="card-body">
                                    <img src="<?php echo $baseUrl; ?>/assets/images/media/media-9.jpg" class="card-img mb-3" alt="...">
                        ...
                        <div class="col-xl-2">
                            <div class="card custom-card">
                                <div class="card-body">
                                    <img src="<?php echo $baseUrl; ?>/assets/images/media/media-15.jpg" class="card-img mb-3" alt="...">
                    ...
                    <div class="row">
                        <div class="col-xl-4">
                            <div class="card custom-card">
                                <img src="<?php echo $baseUrl; ?>/assets/images/media/media-29.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                        ...
                        <div class="col-xl-4">
                            <div class="card custom-card">
                                ...
                                <img src="<?php echo $baseUrl; ?>/assets/images/media/media-28.jpg" class="card-img-bottom" alt="...">
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class="card custom-card">
                                ...
                                <img src="<?php echo $baseUrl; ?>/assets/images/media/media-31.jpg" class="card-img rounded-0" alt="...">
                                <div class="card-footer">
                                    <p class="card-text mb-0"><small>Last updated 3 mins
                                            ago</small></p>
                                </div>
                        ...
                        <div class="col-xl-4">
                            <div class="card custom-card">
                                <img src="<?php echo $baseUrl; ?>/assets/images/media/media-32.jpg" class="card-img-top" alt="...">
                                <div class="card-header">
                                    <div class="card-title">Image caps are widely used in Blog's</div>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-xl-4">
                            <div class="card custom-card">
                                ...
                                <img src="<?php echo $baseUrl; ?>/assets/images/media/media-30.jpg" class="card-img rounded-0" alt="...">
                                <div class="card-body">
                                    <p class="card-text mb-0"><small>Last updated 3 mins
                                            ago</small></p>
                                </div>
                        ...
                        <div class="col-xl-4">
                            <div class="card custom-card">
                                ...
                                <img src="<?php echo $baseUrl; ?>/assets/images/media/media-33.jpg" class="card-img-bottom" alt="...">
                            </div>
                        </div>
                    </div>
                    <!-- End::row-6 -->
                    ...
                    <div class="row">
                        <div class="col-xl-4">
                            <div class="card custom-card overlay-card">
                                <img src="<?php echo $baseUrl; ?>/assets/images/media/media-35.jpg" class="card-img" alt="...">
                                <div class="card-img-overlay d-flex flex-column p-0">
                                    ...
                                    <div class="card-body text-fixed-white overflow-y-auto">
                        ...
                        <div class="col-xl-4">
                            <div class="card custom-card overlay-card">
                                <img src="<?php echo $baseUrl; ?>/assets/images/media/media-36.jpg" class="card-img" alt="...">
                                <div class="card-img-overlay d-flex flex-column p-0 over-content-bottom">
                                    ...
                                    <div class="card-footer text-fixed-white p-sm-3 p-2">Last updated 3 mins ago</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class="card custom-card overlay-card">
                                <img src="<?php echo $baseUrl; ?>/assets/images/media/media-34.jpg" class="card-img" alt="...">
                                <div class="card-img-overlay d-flex flex-column p-0">
                                    <div class="card-header p-sm-3 p-2">
                                        <div class="card-title text-fixed-white">
                                            Image Overlays Are Awesome!
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-xl-4">
                            <div class="card custom-card overflow-hidden">
                                <div class="row g-0">
                                    <div class="col-md-4">
                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/media-37.jpg" class="img-fluid h-100 w-100" alt="...">
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-header">
                        ...
                        <div class="col-xl-4">
                            <div class="card custom-card overflow-hidden">
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-4">
                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/media-38.jpg" class="img-fluid h-100 w-100" alt="...">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class="card custom-card overflow-hidden">
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-4">
                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/media-39.jpg" class="img-fluid h-100 w-100" alt="...">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card-group">
                                <div class="card custom-card">
                                    <img src="<?php echo $baseUrl; ?>/assets/images/media/media-40.jpg" class="card-img-top" alt="...">
                                    <div class="card-body">
                                ...
                                <div class="card custom-card">
                                    <img src="<?php echo $baseUrl; ?>/assets/images/media/media-42.jpg" class="card-img-top" alt="...">
                                    <div class="card-body">
                                ...
                                <div class="card custom-card">
                                    <img src="<?php echo $baseUrl; ?>/assets/images/media/media-41.jpg" class="card-img-top" alt="...">
                                    <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="row row-cols-1 row-cols-md-4 g-4">
                                <div class="col">
                                    <div class="card custom-card">
                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/media-44.jpg" class="card-img-top" alt="...">
                                        <div class="card-body">
                                ...
                                <div class="col">
                                    <div class="card custom-card">
                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/media-43.jpg" class="card-img-top" alt="...">
                                        <div class="card-body">
                                ...
                                <div class="col">
                                    <div class="card custom-card">
                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/media-45.jpg" class="card-img-top" alt="...">
                                        <div class="card-body">
                                ...
                                <div class="col">
                                    <div class="card custom-card">
                                        <img src="<?php echo $baseUrl; ?>/assets/images/media/media-46.jpg" class="card-img-top" alt="...">
                                        <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-3 col-xl-6">
                            <div class="card custom-card">
                                <a href="javascript:void(0);" class="card-anchor"></a>
                                <img src="<?php echo $baseUrl; ?>/assets/images/media/media-47.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h6 class="card-title fw-medium">Most tropical areas are suitable</h6>
                                    <p class="card-text"> If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.</p>
                                </div>

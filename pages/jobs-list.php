                            ...
                            <div class="card custom-card overflow-hidden">
                                <div class="card-header justify-content-between">
                                    ...
                                    <div class="d-flex flex-wrap gap-2">
                                        <a href="job-post.php" class="btn btn-primary btn-wave">
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="job-details.php">Software Engineer</a></p>
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="job-details.php">Data Analyst</a></p>
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="job-details.php">Product Manager</a></p>
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="job-details.php">UI/UX Designer</a></p>
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="job-details.php">Marketing Specialist</a></p>
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="job-details.php">HR Manager</a></p>
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="job-details.php">Full Stack Developer</a></p>
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="job-details.php">Network Administrator</a></p>
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="job-details.php">Customer Support Lead</a></p>
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="job-details.php">Sales Manager</a></p>

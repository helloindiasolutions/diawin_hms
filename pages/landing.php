...
<?php ob_start(); ?>
                ...
                <div class="landing-banner" id="home">
                    <div class="banner-image-container">
                        <img src="<?php echo $baseUrl; ?>/assets/images/media/backgrounds/5.png" alt="">
                    </div>
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-6 my-auto">
                                ...
                                <div class="btn-list banner-buttons">
                                    <a href="index.php" class="btn btn-primary btn-lg rounded-pill btn-w-lg">Get Started for free</a>
                            ...
                            <div class="col-xl-6">
                                <div class="banner-main-img text-end d-xl-block d-none">
                                    <img src="<?php echo $baseUrl; ?>/assets/images/media/backgrounds/7.png" alt="" class="img-fluid">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="card custom-card trusted-clients-container mb-0 border border-dashed">
                                        <div class="card-body">
                                            <img src="<?php echo $baseUrl; ?>/assets/images/company-logos/13.png" alt="" class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="card custom-card trusted-clients-container mb-0 border border-dashed">
                                        <div class="card-body">
                                            <img src="<?php echo $baseUrl; ?>/assets/images/company-logos/14.png" alt="" class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="card custom-card trusted-clients-container mb-0 border border-dashed">
                                        <div class="card-body">
                                            <img src="<?php echo $baseUrl; ?>/assets/images/company-logos/15.png" alt="" class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="card custom-card trusted-clients-container mb-0 border border-dashed">
                                        <div class="card-body">
                                            <img src="<?php echo $baseUrl; ?>/assets/images/company-logos/16.png" alt="" class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="card custom-card trusted-clients-container mb-0 border border-dashed">
                                        <div class="card-body">
                                            <img src="<?php echo $baseUrl; ?>/assets/images/company-logos/17.png" alt="" class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="card custom-card trusted-clients-container mb-0 border border-dashed">
                                        <div class="card-body">
                                            <img src="<?php echo $baseUrl; ?>/assets/images/company-logos/18.png" alt="" class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="card custom-card trusted-clients-container mb-0 border border-dashed">
                                        <div class="card-body">
                                            <img src="<?php echo $baseUrl; ?>/assets/images/company-logos/19.png" alt="" class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="card custom-card trusted-clients-container mb-0 border border-dashed">
                                        <div class="card-body">
                                            <img src="<?php echo $baseUrl; ?>/assets/images/company-logos/20.png" alt="" class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="card custom-card trusted-clients-container mb-0 border border-dashed">
                                        <div class="card-body">
                                            <img src="<?php echo $baseUrl; ?>/assets/images/company-logos/12.png" alt="" class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-5 my-auto">
                                <div class="services-image-container text-end d-xl-block d-none">
                                    <img src="<?php echo $baseUrl; ?>/assets/images/media/media-67.png" alt="" class="img-fluid">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section class="section section-md section-primary text-fixed-white py-5 buy-now-section">
                    <div class="testimonials-background-container">
                        <img src="<?php echo $baseUrl; ?>/assets/images/media/backgrounds/1.png" alt="">
                    </div>
                    <div class="container">
                        <div class="d-flex align-items-center gap-2 justify-content-between flex-wrap">
                            ...
                            <div class="btn-list">
                                <a href="index.php" class="btn btn-danger btn-lg btn-w-md d-inline-flex align-items-center">View Demo<i class="ti ti-arrow-narrow-right ms-2"></i></a>
                ...
                <section class="section section-primary testimonials-section">
                    <div class="testimonials-background-container">
                        <img src="<?php echo $baseUrl; ?>/assets/images/media/backgrounds/2.png" alt="">
                    </div>
                    <div class="container">
                        <div class="heading-section">
                                            ...
                                            <div class="d-flex align-items-end justify-content-between flex-wrap gap-2">
                                                <div class="lh-1">
                                                    <span class="avatar rounded-circle me-2">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/faces/1.jpg" alt="" class="img-fluid rounded-circle">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                    ...
                                    <div class="card custom-card testimonial-style-2-card success border-0">
                                        <div class="card-body p-5">
                                            ...
                                            <div class="d-flex align-items-end justify-content-between flex-wrap gap-2">
                                                <div class="lh-1">
                                                    <span class="avatar rounded-circle me-2">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/faces/10.jpg" alt="" class="img-fluid rounded-circle">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                    ...
                                    <div class="card custom-card testimonial-style-2-card warning border-0">
                                        <div class="card-body p-5">
                                            ...
                                            <div class="d-flex align-items-end justify-content-between flex-wrap gap-2">
                                                <div class="lh-1">
                                                    <span class="avatar rounded-circle me-2">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/faces/9.jpg" alt="" class="img-fluid rounded-circle">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                    ...
                                    <div class="card custom-card testimonial-style-2-card info border-0">
                                        <div class="card-body p-5">
                                            ...
                                            <div class="d-flex align-items-end justify-content-between flex-wrap gap-2">
                                                <div class="lh-1">
                                                    <span class="avatar rounded-circle me-2">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/faces/5.jpg" alt="" class="img-fluid rounded-circle">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                    ...
                                    <div class="card custom-card testimonial-style-2-card danger border-0">
                                        <div class="card-body p-5">
                                            ...
                                            <div class="d-flex align-items-end justify-content-between flex-wrap gap-2">
                                                <div class="lh-1">
                                                    <span class="avatar rounded-circle me-2">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/faces/14.jpg" alt="" class="img-fluid rounded-circle">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                    ...
                                    <div class="card custom-card testimonial-style-2-card teal border-0">
                                        <div class="card-body p-5">
                                            ...
                                            <div class="d-flex align-items-end justify-content-between flex-wrap gap-2">
                                                <div class="lh-1">
                                                    <span class="avatar rounded-circle me-2">
                                                        <img src="<?php echo $baseUrl; ?>/assets/images/faces/3.jpg" alt="" class="img-fluid rounded-circle">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                        ...
                        <div class="row justify-content-between">
                                ...
                                <div class="card custom-card border-0 shadow-none">
                                    <div class="card-body p-4 text-center">
                                        <div class="step-arrow-container d-lg-block d-none">
                                            <img src="<?php echo $baseUrl; ?>/assets/images/media/backgrounds/3.png" alt="" class="img-fluid">
                                        </div>
                                        <div class="lh-1 mb-3">
                            ...
                            <div class="col-lg-3">
                                <div class="card custom-card border-0 shadow-none">
                                    <div class="card-body p-4 text-center">
                                        <div class="step-arrow-container d-lg-block d-none">
                                            <img src="<?php echo $baseUrl; ?>/assets/images/media/backgrounds/4.png" alt="" class="img-fluid">
                                        </div>
                                        <div class="lh-1 mb-3">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-6">
                                <div class="card custom-card">
                                    <img src="<?php echo $baseUrl; ?>/assets/images/faces/team/1.png" class="card-img-top" alt="...">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="card custom-card">
                                    <img src="<?php echo $baseUrl; ?>/assets/images/faces/team/2.png" class="card-img-top" alt="...">
                                    <div class="card-body text-center">
                                        <h6 class="fw-semibold mb-0">
                                            Emily Johnson
                                        </h6>
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="card custom-card">
                                    <img src="<?php echo $baseUrl; ?>/assets/images/faces/team/3.png" class="card-img-top" alt="...">
                                    <div class="card-body text-center">
                                        <h6 class="fw-semibold mb-0">
                                            Sarah Davis
                                        </h6>
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="card custom-card">
                                    <img src="<?php echo $baseUrl; ?>/assets/images/faces/team/4.png" class="card-img-top" alt="...">
                                    <div class="card-body text-center">
                                        <h6 class="fw-semibold mb-0">
                                            Michael Brown
                                        </h6>

...
<?php ob_start(); ?>
                    ...
                    <div class="page-header-breadcrumb mb-3">
                        <div class="d-flex align-center justify-content-between flex-wrap">
                            <h1 class="page-title fw-medium fs-18 mb-0">Data Tables</h1>
                    ...
                    <div class="alert alert-secondary alert-dismissible fs-15 fade show mb-4">
                        We Placed <strong class="text-black">Datatables</strong> only in this page by using <strong class="text-black">jquery</strong> cdn link.

(function () {
    ...
    var chart = new ApexCharts(document.querySelector("#employees-performance"), options);
    chart.render();
    /* Employees Performance */
    ...
    var chart = new ApexCharts(document.querySelector("#candidates-overview"), options);
    chart.render();
    /* Candidates Overview */
